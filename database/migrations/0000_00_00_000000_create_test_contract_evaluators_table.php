...
class CreateTestContractEvaluatorsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('contract_evaluators', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('contract_evaluators');
    }
}
