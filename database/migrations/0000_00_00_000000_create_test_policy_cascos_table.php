...
class CreateTestPolicyCascosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('policy_cascos', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->float('ae_additional_insured_sum', 12, 3)->unsigned()->nullable();
            $table->float('ac_terrorist_attack_for_car', 12, 3)->unsigned()->nullable();
            $table->float('ac_terrorist_attack_for_human', 12, 3)->unsigned()->nullable();
            $table->float('ac_terrorist_attack_evacuation', 12, 3)->unsigned()->nullable();
            $table->string('vi_previous_insurance_info')->nullable();
            $table->float('ec_vehicle_death_recovery_sum', 12, 3)->unsigned()->nullable();
            $table->float('ec_vehicle_death_recovery_premium', 12, 3)->unsigned()->nullable();
            $table->float('ec_vehicle_death_recovery_franchise', 12, 3)->unsigned()->nullable();
    ...
    {
        Schema::dropIfExists('policy_cascos');
    }
}
