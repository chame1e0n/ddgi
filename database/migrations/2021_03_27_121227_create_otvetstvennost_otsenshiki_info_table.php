...
class CreateOtvetstvennostOtsenshikiInfoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('otvetstvennost_otsenshiki_info', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('otvetstvennost_otsenshiki_info');
    }
}
