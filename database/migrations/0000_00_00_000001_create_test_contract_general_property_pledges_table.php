...
class CreateTestContractGeneralPropertyPledgesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('contract_general_property_pledges', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('contract_general_property_pledges');
    }
}
