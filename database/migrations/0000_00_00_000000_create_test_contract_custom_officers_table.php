...
class CreateTestContractCustomOfficersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('contract_custom_officers', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('contract_custom_officers');
    }
}
