...
//        $this->call(UsersTableSeeder::class);
        ...
        DB::table('specifications')->insert([
            ...
            ['type_id' => $type_id, 'key' => 'S_IOSEPUAAP', 'code' => '08', 'name' => 'страхование спец. техники выставляемой в залог',                                                                                                 'is_for_individual' => 1,   'is_for_legal' => 1,    'tariff' => 10, 'max_acceptable_amount' => 100000,  'created_at' => date('Y-m-d H:i:s')],
        ...
        DB::table('specifications')->insert([
            ...
            ['type_id' => $type_id, 'key' => 'S_CLI',           'code' => '04', 'name' => 'страхование гражданской ответственности',                                                                    'is_for_individual' => 1,   'is_for_legal' => 1,    'tariff' => 10, 'max_acceptable_amount' => 100000,  'created_at' => date('Y-m-d H:i:s')],
        ...
        DB::table('payment_methods')->insert([
            ['key' => 'PM_LC',              'code' => '1',   'name' => 'локальная валюта',                                              'created_at' => date('Y-m-d H:i:s')],
            ['key' => 'PM_FC',              'code' => '2',   'name' => 'локальная валюта в иностранной валюте',                         'created_at' => date('Y-m-d H:i:s')],
            ['key' => 'PM_FCOTDOTCOTC',     'code' => '3',   'name' => 'иностранная валюта на день заключения договора',                'created_at' => date('Y-m-d H:i:s')],
            ['key' => 'PM_FCOTDOP',         'code' => '4',   'name' => 'иностранная валюта на день оплаты',                             'created_at' => date('Y-m-d H:i:s')],
            ['key' => 'PM_FCOTDOPOTPOTFT',  'code' => '5',   'name' => 'иностранная валюта на день оплаты премии или первого транша',   'created_at' => date('Y-m-d H:i:s')],
        ]);
        ...
        $branch_id = DB::table('branches')->insertGetId([
            'region_id' => $region_id,
            'code' => '01',
            'name' => 'Департамент инвестиций, страховых резервов и перестрахования',
            'is_center' => 0,
        ...
        $branch_id = DB::table('branches')->insertGetId([
            'region_id' => $region_id,
            'code' => '02',
            'name' => 'Департамент общего страхования',
            'is_center' => 0,
            'founded_date' => '1970-01-01',
            'address' => '',
            'phone_number' => '',
        ...
        $branch_id = DB::table('branches')->insertGetId([
            ...
            'address' => 'г.Бухоро, ул.Б.Накишбандий, дом 31.',
