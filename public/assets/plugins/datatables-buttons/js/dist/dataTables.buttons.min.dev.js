...
(function (d) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (q, p) {
    q || (q = window);
  ...
  d.extend(n.prototype, {
    ...
    add: function add(a, b) {
      ...
      if ("string" === typeof b) {
        for (var e = b.split("-"), d = this.s, c = 0, f = e.length - 1; c < f; c++) {
          d = d.buttons[1 * e[c]];
        }
    ...
    _expandButton: function _expandButton(a, b, c, e) {
      for (var g = this.s.dt, f = 0, b = !d.isArray(b) ? [b] : b, h = 0, l = b.length; h < l; h++) {
        ...
        if (o) if (d.isArray(o)) this._expandButton(a, o, c, e);else {
          ...
          j && (e !== m ? (a.splice(e, 0, j), e++) : a.push(j), j.conf.buttons && (j.collection = d("<" + this.c.dom.collection.tag + "/>"), j.conf._collection = j.collection, this._expandButton(j.buttons, j.conf.buttons, !0, e)), o.init && o.init.call(g.button(j.node), g, d(j.node), o), f++);
        }
      }
    },
  ...
  n.instanceSelector = function (a, b) {
    ...
    var c = [],
      ...
      return a.name;
        ...
        g = function g(a) {
      if (d.isArray(a)) for (var h = 0, l = a.length; h < l; h++) {
        g(a[h]);
  ...
  i.Api.register("buttons().containers()", function () {
    ...
    this.iterator(!0, "table", function (c) {
      if (c._buttons) for (var c = n.instanceSelector(b, c._buttons), d = 0, g = c.length; d < g; d++) {
