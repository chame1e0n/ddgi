...
(function (g) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (d, f) {
    d || (d = window);
    ...
    columnVisibility: {
      ...
      init: function init(a, b, c) {
        ...
        a.on("column-visibility.dt" + c.namespace, function (b, d) {
          ...
          1 === a.columns(c.columns).count() && (b.text(c._columnText(a, c)), e.active(a.column(c.columns).visible()));
        });
