      ...
      setupClone: function setupClone(t) {
        ...
        if (this.isMultiDrag) {
          for (var o = 0; o < se.length; o++) {
            ce.push(S(se[o])), ce[o].sortableIndex = se[o].sortableIndex, ce[o].draggable = !1, ce[o].style["will-change"] = "", k(ce[o], this.options.selectedClass, !1), se[o] === re && k(ce[o], this.options.chosenClass, !1);
          }
