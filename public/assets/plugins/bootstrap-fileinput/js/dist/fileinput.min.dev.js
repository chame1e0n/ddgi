...
!function (e) {
  ...
  t = {
    ...
    getZoomSelector: function getZoomSelector(e, i) {
    ...
    _initResumableUpload: function _initResumableUpload() {
      ...
      if (a.enableResumableUpload) {
        ...
        i = a.resumableManager = {
          ...
          setAjaxError: function setAjaxError(e, t, o, l) {
          ...
          sendAjax: function sendAjax(e, l, s) {
            var d,
                c = i.chunkSize,
                u = i.id,
                p = i.file,
            ...
            if (!i.chunksProcessed[u] || !i.chunksProcessed[u][e]) {
              ...
              v = new FormData(), d = o.stack[u], a._setUploadData(v, {
                ...
                fileSize: p.size,
                retryCount: l
              }), i.$progress && i.$progress.length && i.$progress.show(), b = function b(r) {
    ...
    _listen: function _listen() {
      ...
      }), n._handler(o, "change", e.proxy(n._change, n)), n.showBrowse && n._handler(n.$btnFile, "click", e.proxy(n._browse, n)), a = s.find(".file-caption-name"), r = function r() {
        return !1;
    ...
    _scanDroppedItems: function _scanDroppedItems(e, i, a) {
      ...
      }, s) : e.isDirectory && (n = e.createReader(), (_o = function o() {
    ...
    _initXhr: function _initXhr(e, i) {
      var a = this,
          r = a.fileManager,
          n = function n(e) {
        var n = 0,
    ...
    _uploadSingle: function _uploadSingle(i, a, r) {
      ...
      w.enableResumableUpload || (w.showPreview && (o = w.fileManager.getThumb(a), u = o.find(".file-thumb-progress"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), u.show()), 0 === _ || !x || w.showPreview && s && s.hasClass("disabled") || w._abort(F) || (v = function v() {
    ...
    _setFileData: function _setFileData(e, t, i, a) {
      var r = this,
    ...
    _setFileUploadStats: function _setFileUploadStats(i, a, r) {
      var n = this,
          o = n.$progress;
    ...
    readFiles: function readFiles(i) {
      ...
      r.fileManager.clearImages(), e.each(i, function (e, t) {
        ...
        if (j) {
          if (S = C.getId(j), g > 0) for (x = 0; g > x; x++) {
            k = f[x], E = r.msgFileTypes[k] || k, Z += 0 === x ? E : ", " + E;
          }
          if (R === !1) return void _a2(w + 1);
          ...
          if (t.isEmpty(m) || (B = new RegExp("\\.(" + m.join("|") + ")$", "i")), y = O.toFixed(2), r.isAjaxUpload && C.exists(S) || r._getFrame(U, !0).length) {
            ...
            return T = r.msgDuplicateFile.setTokens({
              name: R,
              size: y
            }), void (r.isAjaxUpload ? (r.duplicateErrors.push(T), r.isDuplicateError = !0, r._raise("fileduplicateerror", [j, S, R, y, U, w]), _a2(w + 1), r._updateFileDetails(u)) : (r._showError(T, V), r.unlock(), u = 0, r._clearFileInput(), r.reset(), r._updateFileDetails(u)));
          }
          ...
          if (!r._canPreview(j)) return I = r.isAjaxUpload && r._raise("filebeforeload", [j, w, n]), r.isAjaxUpload && I && C.add(j), r.showPreview && I && (o.addClass("file-thumb-loading"), r._previewDefault(j), r._initFileActions()), void setTimeout(function () {
            I && r._updateFileDetails(u), _a2(w + 1), r._raise("fileloaded", [j, U, M, w]);
          }, 10);
