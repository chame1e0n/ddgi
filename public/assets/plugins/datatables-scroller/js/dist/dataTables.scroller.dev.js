...
(function (factory) {
  ...
  $.extend(Scroller.prototype, {
    ...
    measure: function measure(redraw) {
      ...
      if (heights.row) {
        heights.viewport = $.contains(document, this.dom.scroller) ? this.dom.scroller.clientHeight : this._parseHeight($(this.dom.scroller).css('height')); // If collapsed (no height) use the max-height parameter
    ...
    */
    ...
    construct: function construct() {
      ...
      this.measure(false); // Scrolling callback to see if a page change is needed - use a throttled
