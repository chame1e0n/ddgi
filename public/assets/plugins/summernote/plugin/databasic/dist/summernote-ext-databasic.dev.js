...
(function (factory) {
  ...
  var dom = $.summernote.dom; // define the popover plugin

  var DataBasicPlugin = function DataBasicPlugin(context) {
    var self = this;
    var options = context.options;
    var lang = options.langInfo;
    self.icon = '<i class="fa fa-object-group"/>'; // add context menu button for dialog
    ...
    self.initialize = function () {
      ...
      self.$dialog = ui.dialog({
        ...
        body: body,
        footer: footer
      }).render().appendTo($container); // create popover
    ...
    self.createNode = function (info) {
      ...
      if ($node) {
        ...
        info.node = $node; // insert node into editor dom
    ...
    self.showDialog = function () {
      ...
      self.openDialog(info).then(function (dialogInfo) {
        ...
        context.invoke('editor.restoreRange'); // insert a new node
