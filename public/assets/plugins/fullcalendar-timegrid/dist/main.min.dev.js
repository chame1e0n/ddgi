...
*/
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? t(exports, require("@fullcalendar/core"), require("@fullcalendar/daygrid")) : "function" == typeof define && define.amd ? define(["exports", "@fullcalendar/core", "@fullcalendar/daygrid"], t) : t((e = e || self).FullCalendarTimeGrid = {}, e.FullCalendar, e.FullCalendarDayGrid);
}(void 0, function (e, t, r) {
  "use strict";
  ...
  var _o = function o() {
    ...
    return n(r, e), r.prototype.renderSegs = function (r, i, n) {
      ...
      var t = this.timeGrid,
          r = this.segsByCol,
          i = t.colCnt;
      if (t.computeSegVerticals(e), r) for (var n = 0; n < i; n++) {
      ...
      var t = this.timeGrid,
          r = this.segsByCol,
          i = t.colCnt;
      if (t.assignSegVerticals(e), r) for (var n = 0; n < i; n++) {
      ...
      var i,
          n = e.forwardSegs;
      if (void 0 === e.forwardCoord) for (n.length ? (this.sortForwardSegs(n), this.computeSegForwardBack(n[0], t + 1, r), e.forwardCoord = n[0].backwardCoord) : e.forwardCoord = 1, e.backwardCoord = e.forwardCoord - (e.forwardCoord - r) / (t + 1), i = 0; i < n.length; i++) {
  ...
  var c = function (e) {
    ...
    return n(i, e), i.prototype._processOptions = function (e) {
      ...
      for (var n = 0; n < this.colCnt; n++) {
        i.push('<td><div class="fc-content-col"><div class="fc-event-container fc-mirror-container"></div><div class="fc-event-container"></div><div class="fc-highlight-container"></div><div class="fc-bgevent-container"></div><div class="fc-business-container"></div></div></td>');
      }
      ...
      for (t = 0; t < e.length; t++) {
        r = e[t], i = this.props.cells[r.col].date, r.top = this.computeDateTop(r.start, i), r.bottom = Math.max(r.top + n, this.computeDateTop(r.end, i));
      }
  ...
  var y = function (e) {
    ...
    return n(r, e), r.prototype.firstContext = function (e) {
      ...
      this.timeGrid.receiveProps(_o({}, this.slicer.sliceProps(e, i, null, t.calendar, this.timeGrid, s), {
        dateProfile: i,
        cells: n.cells[0]
      }), t);
  ...
  var S = function (e) {
    ...
    return n(i, e), i.prototype.render = function (t, r) {
      ...
      }, r), this.simpleTimeGrid.receiveProps(_o({}, d.timed, {
        dateProfile: n,
        dayTable: l
      }), r), this.simpleDayGrid && this.simpleDayGrid.receiveProps(_o({}, d.allDay, {
        dateProfile: n,
        dayTable: l,
        nextDayThreshold: a,
        isRigid: !1
