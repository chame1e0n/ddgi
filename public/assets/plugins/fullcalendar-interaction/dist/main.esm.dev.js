...
exports.ThirdPartyDraggable = exports.PointerDragging = exports.FeaturefulElementDragging = exports.Draggable = exports["default"] = void 0;
...
_core.config.touchMouseIgnoreWait = 500;
...
function () {
  function PointerDragging(containerEl) {
    ...
    this.emitter = new _core.EmitterMixin();
  ...
  PointerDragging.prototype.tryStart = function (ev) {
    ...
    if (subjectEl && (!this.handleSelector || (0, _core.elementClosest)(downEl, this.handleSelector))) {
  ...
  PointerDragging.prototype.querySubjectEl = function (ev) {
    if (this.selector) {
      return (0, _core.elementClosest)(ev.target, this.selector);
    } else {
...
function startIgnoringMouse() {
  ...
  setTimeout(function () {
    ignoreMouseDepth--;
  }, _core.config.touchMouseIgnoreWait);
...
function () {
  ...
  ElementMirror.prototype.doRevertAnimation = function (callback, revertDuration) {
    ...
    (0, _core.applyStyle)(mirrorEl, {
      left: finalSourceElRect.left,
      top: finalSourceElRect.top
    });
    (0, _core.whenTransitionDone)(mirrorEl, function () {
  ...
  ElementMirror.prototype.cleanup = function () {
    if (this.mirrorEl) {
      (0, _core.removeElement)(this.mirrorEl);
      this.mirrorEl = null;
    }
  ...
  ElementMirror.prototype.updateElPosition = function () {
    if (this.sourceEl && this.isVisible) {
      (0, _core.applyStyle)(this.getMirrorEl(), {
...
function (_super) {
  ...
  function ElementScrollGeomCache(el, doesListening) {
    return _super.call(this, new _core.ElementScrollController(el), doesListening) || this;
  }
  ...
  ElementScrollGeomCache.prototype.computeClientRect = function () {
    return (0, _core.computeInnerRect)(this.scrollController.el);
  };
...
function (_super) {
  ...
  function WindowScrollGeomCache(doesListening) {
    return _super.call(this, new _core.WindowScrollController(), doesListening) || this;
  }
  ...
  function FeaturefulElementDragging(containerEl) {
    ...
    _this.onPointerDown = function (ev) {
      if (!_this.isDragging) {
        ...
        _this.isDelayEnded = false;
        _this.isDistanceSurpassed = false;
        (0, _core.preventSelection)(document.body);
        (0, _core.preventContextMenu)(document.body); // prevent links from being visited if there's an eventual drag.
    ...
    _this.onPointerUp = function (ev) {
      if (_this.isInteracting) {
        ...
        (0, _core.allowSelection)(document.body);
        (0, _core.allowContextMenu)(document.body);
...
function () {
  function OffsetTracker(el) {
    this.origRect = (0, _core.computeRect)(el); // will work fine for divs that have overflow:hidden

    this.scrollCaches = (0, _core.getClippingParents)(el).map(function (el) {
  ...
  OffsetTracker.prototype.isWithinClipping = function (pageX, pageY) {
    ...
    for (var _i = 0, _a = this.scrollCaches; _i < _a.length; _i++) {
      ...
      if (!isIgnoredClipping(scrollCache.getEventTarget()) && !(0, _core.pointInsideRect)(point, scrollCache.clientRect)) {
        return false;
      }
    }
...
function () {
  ...
  HitDragging.prototype.processFirstCoord = function (ev) {
    ...
    if (subjectEl !== document) {
      subjectRect = (0, _core.computeRect)(subjectEl);
      adjustedPoint = (0, _core.constrainPoint)(adjustedPoint, subjectRect);
    }
    ...
    if (initialHit) {
      if (this.useSubjectCenter && subjectRect) {
        var slicedSubjectRect = (0, _core.intersectRects)(subjectRect, initialHit.rect);

        if (slicedSubjectRect) {
          adjustedPoint = (0, _core.getRectCenter)(slicedSubjectRect);
        }
      }

      this.coordAdjust = (0, _core.diffPoints)(adjustedPoint, origPoint);
    } else {
      this.coordAdjust = {
        left: 0,
        top: 0
  ...
  HitDragging.prototype.prepareHits = function () {
    this.offsetTrackers = (0, _core.mapHash)(this.droppableStore, function (interactionSettings) {
    ...
    for (var id in droppableStore) {
      ...
      if (offsetTracker.isWithinClipping(offsetLeft, offsetTop)) {
        ...
        positionLeft >= 0 && positionLeft < width && positionTop >= 0 && positionTop < height) {
          ...
          (0, _core.rangeContainsRange)(component.props.dateProfile.activeRange, hit.dateSpan.range)) && (!bestHit || hit.layer > bestHit.layer)) {
...
function isHitsEqual(hit0, hit1) {
  ...
  return (0, _core.isDateSpansEqual)(hit0.dateSpan, hit1.dateSpan);
}
/*
...
function (_super) {
  ...
  function DateClicking(settings) {
    ...
    var hitDragging = _this.hitDragging = new HitDragging(_this.dragging, (0, _core.interactionSettingsToStore)(settings));
...
function (_super) {
  ...
  function DateSelecting(settings) {
    ...
    _this.handleHitUpdate = function (hit, isFinal) {
      ...
      if (!isInvalid) {
        (0, _core.enableCursor)();
      } else {
        (0, _core.disableCursor)();
      }
...
function (_super) {
  ...
  function EventDragging(settings) {
    ...
    _this.handlePointerDown = function (ev) {
      ...
      var subjectSeg = _this.subjectSeg = (0, _core.getElSeg)(ev.subjectEl);
      var eventRange = _this.eventRange = subjectSeg.eventRange;
      var eventInstanceId = eventRange.instance.instanceId;
      _this.relevantEvents = (0, _core.getRelevantEvents)(initialCalendar.state.eventStore, eventInstanceId);
      ...
      var isValid = component.isValidSegDownEl(origTarget) && !(0, _core.elementClosest)(origTarget, '.fc-resizer'); // NOT on a resizer
    ...
    _this.handleDragStart = function (ev) {
      ...
      if (_this.isDragging) {
        ...
        initialCalendar.publiclyTrigger('eventDragStart', [{
          ...
          event: new _core.EventApi(initialCalendar, eventRange.def, eventRange.instance),
    ...
    _this.handleHitUpdate = function (hit, isFinal) {
      ...
      var interaction = {
        ...
        mutatedEvents: (0, _core.createEmptyEventStore)(),
        isEvent: true,
      ...
      if (hit) {
        ...
        if (initialCalendar === receivingCalendar || receivingOptions.editable && receivingOptions.droppable) {
          ...
          if (mutation) {
            mutatedRelevantEvents = (0, _core.applyMutationToEventStore)(relevantEvents, receivingCalendar.eventUiBases, mutation, receivingCalendar);
            ...
            if (!receivingComponent.isInteractionValid(interaction)) {
              ...
              interaction.mutatedEvents = (0, _core.createEmptyEventStore)();
            }
          }
        } else {
    ...
    _this.handleDragEnd = function (ev) {
      if (_this.isDragging) {
        ...
        var eventApi = new _core.EventApi(initialCalendar_1, eventDef, eventInstance);
        ...
        if (validMutation) {
          ...
          if (receivingCalendar === initialCalendar_1) {
            ...
            var eventDropArg = _assign({}, transformed, {
              ...
              oldEvent: eventApi,
              event: new _core.EventApi( // the data AFTER the mutation
    ...
    dragging.touchScrollAllowed = false;
    dragging.autoScroller.isEnabled = options.dragScroll;
    var hitDragging = _this.hitDragging = new HitDragging(_this.dragging, _core.interactionSettingsStore);
...
function computeEventMutation(hit0, hit1, massagers) {
  ...
  if (dateSpan0.allDay !== dateSpan1.allDay) {
    ...
    if (dateSpan1.allDay) {
      ...
      date0 = (0, _core.startOfDay)(date0);
    }
  }

  var delta = (0, _core.diffDates)(date0, date1, hit0.component.context.dateEnv, hit0.component === hit1.component ? hit0.component.largeUnit : null);
...
function (_super) {
  ...
  function EventDragging(settings) {
    ...
    _this.handleDragStart = function (ev) {
      var _a = _this.component.context,
          ...
          view = _a.view;
      var eventRange = _this.eventRange;
      _this.relevantEvents = (0, _core.getRelevantEvents)(calendar.state.eventStore, _this.eventRange.instance.instanceId);
      _this.draggingSeg = _this.querySeg(ev);
      calendar.unselect();
      calendar.publiclyTrigger('eventResizeStart', [{
        el: _this.draggingSeg.el,
        event: new _core.EventApi(calendar, eventRange.def, eventRange.instance),
        jsEvent: ev.origEvent,
        view: view
      }]);
    };
    ...
    _this.handleHitUpdate = function (hit, isFinal, ev) {
      ...
      if (mutation) {
        mutatedRelevantEvents = (0, _core.applyMutationToEventStore)(relevantEvents, calendar.eventUiBases, mutation, calendar);
        interaction.mutatedEvents = mutatedRelevantEvents;
    ...
    _this.handleDragEnd = function (ev) {
      ...
      var eventDef = _this.eventRange.def;
      var eventInstance = _this.eventRange.instance;
      var eventApi = new _core.EventApi(calendar, eventDef, eventInstance);
      var relevantEvents = _this.relevantEvents;
      var mutatedRelevantEvents = _this.mutatedRelevantEvents;
      ...
      if (_this.validMutation) {
        ...
        calendar.publiclyTrigger('eventResize', [{
          el: _this.draggingSeg.el,
          startDelta: _this.validMutation.startDelta || (0, _core.createDuration)(0),
          endDelta: _this.validMutation.endDelta || (0, _core.createDuration)(0),
          prevEvent: eventApi,
          event: new _core.EventApi( // the data AFTER the mutation
  ...
  EventDragging.prototype.querySeg = function (ev) {
    return (0, _core.getElSeg)((0, _core.elementClosest)(ev.subjectEl, this.component.fgSegSelector));
  };
...
function computeMutation(hit0, hit1, isFromStart, instanceRange, transforms) {
  ...
  var delta = (0, _core.diffDates)(date0, date1, dateEnv, hit0.component.largeUnit);
  var props = {};
    ...
    this.onDocumentPointerUp = function (pev) {
      ...
      if (!documentPointer.wasTouchScroll) {
        ...
        !_this.isRecentPointerDateSelect // a new pointer-initiated date selection since last onDocumentPointerUp?
            ...
            if (unselectAuto && (!unselectAuto || !(0, _core.elementClosest)(documentPointer.downEl, unselectCancel))) {
              calendar.unselect(pev);
            }
          }

        if (state.eventSelection && // an existing event selected?
        !(0, _core.elementClosest)(documentPointer.downEl, EventDragging.SELECTOR) // interaction DIDN'T start on an event
        ) {
            calendar.dispatch({
              type: 'UNSELECT_EVENT'
            });
...
function () {
  function ExternalElementDragging(dragging, suppliedDragMeta) {
    ...
    this.handleHitUpdate = function (hit, isFinal, ev) {
      ...
      var isInvalid = false;
      var interaction = {
        affectedEvents: (0, _core.createEmptyEventStore)(),
        mutatedEvents: (0, _core.createEmptyEventStore)(),
      ...
      if (hit) {
        ...
        if (_this.canDropElOnCalendar(ev.subjectEl, receivingCalendar)) {
          ...
          interaction.mutatedEvents = (0, _core.eventTupleToStore)(droppableEvent);
          isInvalid = !(0, _core.isInteractionValid)(interaction, receivingCalendar);
    ...
    this.handleDragEnd = function (pev) {
      ...
      if (receivingCalendar && droppableEvent) {
        ...
        if (dragMeta.create) {
          receivingCalendar.dispatch({
            type: 'MERGE_EVENTS',
            eventStore: (0, _core.eventTupleToStore)(droppableEvent)
          });
          ...
          receivingCalendar.publiclyTrigger('eventReceive', [{
            draggedEl: pev.subjectEl,
            event: new _core.EventApi(receivingCalendar, droppableEvent.def, droppableEvent.instance),
            view: finalView
          }]);
        }
      }
    ...
    var hitDragging = this.hitDragging = new HitDragging(dragging, _core.interactionSettingsStore);
  ...
  ExternalElementDragging.prototype.buildDragMeta = function (subjectEl) {
    if (_typeof(this.suppliedDragMeta) === 'object') {
      return (0, _core.parseDragMeta)(this.suppliedDragMeta);
    } else if (typeof this.suppliedDragMeta === 'function') {
      return (0, _core.parseDragMeta)(this.suppliedDragMeta(subjectEl));
    } else {
  ...
  ExternalElementDragging.prototype.canDropElOnCalendar = function (el, receivingCalendar) {
    ...
    if (typeof dropAccept === 'function') {
      ...
      return Boolean((0, _core.elementMatches)(el, dropAccept));
    }
...
function computeEventForDateSpan(dateSpan, dragMeta, calendar) {
  ...
  var def = (0, _core.parseEventDef)(defProps, dragMeta.sourceId, dateSpan.allDay, calendar.opt('forceEventDuration') || Boolean(dragMeta.duration), // hasEnd
  calendar);
  ...
  var instance = (0, _core.createEventInstance)(def.defId, {
    start: start,
    end: end
  });
  return {
...
function getDragMetaFromEl(el) {
  ...
  return (0, _core.parseDragMeta)(obj);
}

_core.config.dataAttrPrefix = '';

function getEmbeddedElData(el, name) {
  var prefix = _core.config.dataAttrPrefix;
...
function () {
  function ExternalDraggable(el, settings) {
    ...
    this.handlePointerDown = function (ev) {
      ...
      dragging.minDistance = minDistance != null ? minDistance : ev.isTouch ? 0 : _core.globalDefaults.eventDragMinDistance;
      dragging.delay = ev.isTouch ? // TODO: eventually read eventLongPressDelay instead vvv
      longPressDelay != null ? longPressDelay : _core.globalDefaults.longPressDelay : 0;
    };
