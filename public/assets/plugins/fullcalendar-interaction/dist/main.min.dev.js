...
*/
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? t(exports, require("@fullcalendar/core")) : "function" == typeof define && define.amd ? define(["exports", "@fullcalendar/core"], t) : t((e = e || self).FullCalendarInteraction = {}, e.FullCalendar);
}(void 0, function (e, t) {
  "use strict";
        ...
        if (o.isDragging) {
          ...
          if (o.clearDrag(), r.publiclyTrigger("eventDragStop", [{
            ...
            if (s === r) {
              ...
              var D = _i({}, s.buildDatePointApi(v.dateSpan), {
                draggedEl: e.subjectEl,
                jsEvent: e.origEvent,
                view: v.component
              });
  ...
  var M = function () {
    ...
    function e(e, n) {
      ...
      this.receivingCalendar = null, this.droppableEvent = null, this.suppliedDragMeta = null, this.dragMeta = null, this.handleDragStart = function (e) {
        ...
        e && (l = e.component.context.calendar, r.canDropElOnCalendar(o.subjectEl, l) && (s = function (e, n, r) {
          for (var o = _i({}, n.leftoverProps), a = 0, l = r.pluginSystem.hooks.externalDefTransforms; a < l.length; a++) {
            var s = l[a];
        ...
        if (r.clearDrag(), o && a) {
          var l = r.hitDragging.finalHit,
              ...
              c = r.dragMeta,
              d = _i({}, o.buildDatePointApi(l.dateSpan), {
            draggedEl: e.subjectEl,
            jsEvent: e.origEvent,
            view: s
          });
    ...
    return e.prototype.buildDragMeta = function (e) {
      return "object" == _typeof(this.suppliedDragMeta) ? t.parseDragMeta(this.suppliedDragMeta) : "function" == typeof this.suppliedDragMeta ? t.parseDragMeta(this.suppliedDragMeta(e)) : (n = function (e, n) {
