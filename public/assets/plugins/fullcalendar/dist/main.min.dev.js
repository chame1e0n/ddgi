...
*/
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t((e = e || self).FullCalendar = {});
}(void 0, function (e) {
  "use strict";
  ...
  function J(e, t) {
    ...
    return "string" == typeof e ? function (e) {
      ...
      return null;
    }(e) : "object" == _typeof(e) && e ? K(e) : "number" == typeof e ? K(((n = {})[t || "milliseconds"] = e, n)) : null;
  }
  ...
  var _me = function me(e, t) {
    return (_me = Object.setPrototypeOf || {
      __proto__: []
  ...
  function Ee(e, t) {
    ...
    _me(e, t), e.prototype = null === t ? Object.create(t) : (n.prototype = t.prototype, new n());
  }
  ...
  function Te(e, t) {
    ...
    if (t) for (n = 0; n < t.length; n++) {
      for (r = t[n], i = [], o = e.length - 1; o >= 0; o--) {
        if ("object" == _typeof(a = e[o][r]) && a) i.unshift(a);else if (void 0 !== a) {
          u[r] = a;
          break;
        }
      }
  ...
  function He(e, t) {
    return {
      defs: _Se({}, e.defs, t.defs),
      instances: _Se({}, e.instances, t.instances)
    };
  }
  ...
  function ot(e, t) {
    return "object" == _typeof(e) && e ? ("string" == typeof t && (e = _Se({
      separator: t
  ...
  var lt = function () {
    ...
    return e.prototype.setProp = function (e, t) {
      var n, r;
      if (e in Ft) ;else if (e in At) "function" == typeof At[e] && (t = At[e](t)), this.mutate({
  ...
  function St(e, t, n, r, i) {
    ...
    n.extendedProps && (a.extendedProps = _Se({}, a.extendedProps, n.extendedProps));
      ...
      case "CHANGE_TIMEZONE":
        return function (e, t, n) {
          var r = e.defs,
            ...
            var i = r[e.defId];
            return i.allDay || i.recurringDef ? e : _Se({}, e, {
              range: {
  ...
  function kt(e, t, n, r, i) {
    return "businessHours" === e ? _t(Oe(r, t, i)) : "string" == typeof e ? _t(Ue(n, function (t) {
      return t.groupId === e;
    })) : "object" == _typeof(e) && e ? _t(Oe(e, t, i)) : [];
  }
  ...
  function Ut(e, t, n) {
    var r = he(e, Ht, {}, n),
        i = function (e, t) {
      return Array.isArray(e) ? ke(e, "", t, !0) : "object" == _typeof(e) && e ? ke([e], "", t, !0) : null != e ? String(e) : null;
    }(r.constraint, t);
  ...
  function zt(e, t, n, r) {
    ...
    if ("event" === e && (i.editable = t.editable), r) for (var a in t) {
      o[a] || (r[a] = t[a]);
    }
    return Ut(i, n);
  }
  ...
  function Zt(e, t, n, r) {
    var i = function (e, t) {
      ...
      for (var o = 0; o < r.length; o++) {
        ...
        if (s) {
          var u = a.allDay;
          return delete a.allDay, null == u && null == (u = t) && null == (u = s.allDayGuess) && (u = !1), _Se(i, a), {
            allDay: u,
            duration: s.duration,
            typeData: s.typeData,
            typeId: o
  ...
  function jt(e, t, n, r, i) {
    ...
    return a.extendedProps = _Se(o, a.extendedProps || {}), Object.freeze(a.ui.classNames), Object.freeze(a.extendedProps), a;
  }
  ...
  var sn = function () {
    ...
    return e.prototype.processIconOverride = function () {
      ...
      if ("object" == _typeof(e) && e) {
        for (n in t = _Se({}, this.iconClasses), e) {
  ...
  var pn = 0,
    ...
    return e.addEqualityFuncs = function (e) {
      this.prototype.equalityFuncs = _Se({}, this.prototype.equalityFuncs, e);
    ...
    return e.prototype.add = function (e) {
      if (!this.addedHash[e.id]) {
        ...
        this.hooks = (i = this.hooks, o = e, {
          ...
          themeClasses: _Se({}, i.themeClasses, o.themeClasses),
          ...
          optionChangeHandlers: _Se({}, i.optionChangeHandlers, o.optionChangeHandlers)
        });
      }
    ...
    eventSourceDefs: [{
      parseMeta: function parseMeta(e) {
        if ("string" == typeof e) e = {
          url: e
        };else if (!e || "object" != _typeof(e) || !e.url) return null;
        return {
          url: e.url,
      ...
      fetch: function fetch(e, t, n) {
        var r = e.eventSource.meta,
          ...
          _Se(u, a), u[r] = s.formatIso(t.start), u[i] = s.formatIso(t.end), "local" !== s.timeZone && (u[o] = s.timeZone);
          return u;
  ...
  var Cn = mn({
    optionChangeHandlers: {
      events: function events(e, t, n) {
        In([e], t, n);
      },
      eventSources: In,
      plugins: function plugins(e, t) {
        t.addPluginInputs(e);
      }
    }
  });
  ...
  var Un = function () {
    function e(e) {
      this.overrides = _Se({}, e), this.dynamicOverrides = {}, this.compute();
    }
  ...
  function Yn(e, t) {
    for (var n = t.pluginSystem.hooks.eventSourceDefs, r = n.length - 1; r >= 0; r--) {
      ...
      if (i) {
        var o = qn("object" == _typeof(e) ? e : {}, i, r, t);
        return o._raw = e, o;
      }
    }
    ...
    switch (t.type) {
      ...
      case "RECEIVE_EVENT_ERROR":
        return function (e, t, n, r) {
          var i,
              o = e[t];
          if (o && n === o.latestFetchId) return _Se({}, e, ((i = {})[t] = _Se({}, o, {
            isFetching: !1,
            fetchRange: r
          }), i));
          return e;
  ...
  function er(e, t, n) {
    for (var r = function (e, t) {
      ...
      var s, u;
    }(e.dateProfile, t, e.currentDate, r, n), o = Gn(e.eventSources, t, i, n), a = _Se({}, e, {
      viewType: r,
      dateProfile: i,
  ...
  function cr(e, t, n, r) {
    ...
    var i = function (e, t, n, r) {
      ...
      return {
        type: e,
        "class": s,
        defaults: _Se({}, l ? l.defaults : {}, i ? i.options : {}),
        overrides: _Se({}, l ? l.overrides : {}, o ? o.options : {})
      };
    }(e, t, n, r);
    ...
    return Re(function (e, t) {
      ...
      return function (e, t, n) {
        ...
        return {
          ...
          durationUnit: o,
          singleUnit: a,
          options: _Se({}, Mn, e.defaults, n.dirDefaults, n.localeDefaults, n.overrides, s, e.overrides, n.dynamicOverrides),
  ...
  var gr = function (e) {
    ...
    return Ee(t, e), t.prototype.destroy = function () {
      ...
      return t && t.split(" ").forEach(function (e, t) {
        ...
        if (e.split(",").forEach(function (e, t) {
          ...
          "title" === e ? (o.push(i("<h2>&nbsp;</h2>")), l = !1) : ((r = f[e]) ? (d = function d(e) {
            r.click && r.click.call(E, e);
          }, (v = a.getCustomButtonIconClass(r)) || (v = a.getIconClass(e)) || (g = r.text)) : (s = c[e]) ? (n.viewsWithButtons.push(e), d = function d() {
            u.changeView(e);
          }, (g = s.buttonTextOverride) || (v = a.getIconClass(e)) || (g = s.buttonTextDefault)) : u[e] && (d = function d() {
            u[e]();
    ...
    return Ee(t, e), t.prototype.render = function (e, t) {
      ...
      d ? (o || (o = this.header = new gr("fc-header-toolbar"), u(this.el, o.el)), o.receiveProps(_Se({
        layout: d
      }, m), i)) : o && (o.destroy(), o = this.header = null), f ? (a || (a = this.footer = new gr("fc-footer-toolbar"), s(this.el, a.el)), a.receiveProps(_Se({
        layout: f
  ...
  var Cr = function () {
    ...
    return e.prototype.addPluginInputs = function (e) {
      ...
      this.optionsManager.mutate(a, t, n), d && this.handleOptions(this.optionsManager.computed), this.batchRendering(function () {
        ...
        })) : c && i.updateSize(), r) for (var e in s) {
          o[e](s[e], i, r);
        }
      });
      ...
      var n = _Se({}, this.buildDateSpanApi(e), {
      ...
      var i = _Se({}, this.buildDatePointApi(e), {
        dayEl: t,
        jsEvent: r,
        view: n
      });
  ...
  var xr = function (e) {
    ...
    return Ee(t, e), t.prototype.initialize = function () {}, Object.defineProperty(t.prototype, "activeStart", {
      ...
      t && (e.isForced = t), _Se(this.queuedScroll || (this.queuedScroll = {}), e);
      ...
      var e = {};
      return this.props.dateProfile && _Se(e, this.queryDateScroll()), e;
    }, t.prototype.applyScroll = function (e, t) {
      var n = e.duration,
          r = e.isForced;
      null == n || r || (delete e.duration, this.props.dateProfile && _Se(e, this.computeDateScroll(n))), this.props.dateProfile && this.applyDateScroll(e);
  ...
  var Zr = function (e) {
    ...
    function e(e, t) {
      for (var n = e.start, r = e.end, i = [], o = [], a = -1; n < r;) {
        t.isHiddenDay(n) ? i.push(a + .5) : (a++, i.push(a), o.push(n)), n = x(n, 1);
      }
