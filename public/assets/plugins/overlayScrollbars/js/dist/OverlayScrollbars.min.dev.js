...
!function (n, t) {
...
}("undefined" != typeof window ? window : void 0, function (gt, mt, bi) {
  "use strict";
  ...
  function r(n, t) {
    if (_typeof(n) != yt) throw "Can't bind function!";
  ...
  function x(n, t, r, e, i, o) {
    ...
    if (L(d)) o && R(f);else {
      ...
      if (-1 === z && (z = f.q[gi.l], f.q.push(k)), 0 === z) if (0 < l) _ = mi.now(), _O = function O() {
  ...
  function D(n) {
    ...
    var t,
        ...
        i = n,
        o = 0;
    if (d(n) == _t) for (i = [], t = "<" === n.charAt(0) ? ((r = mt.createElement("div")).innerHTML = n, r.children) : mt.querySelectorAll(n); o < t[gi.l]; o++) {
      i.push(t[o]);
    }
  ...
  function G(r) {
    ...
    this.add = function (n) {
      ...
      var t = e(n, h);
      -1 < t && (d.splice(t, 1), h.splice(t, 1), 0 === h[v] && p && (p = !1, r.autoUpdateLoop = p, c !== bi && (mi.cAF()(c), c = -1)));
    };
  }
  ...
  function K(r, n, t, kt, Ct) {
      ...
      if (n) {
        ...
        if (t) {
          if (T) ((C = n.addClass("observed").append(li(_n)).contents()[0])[Z] = new r(u)).observe(C);else if (9 < R || !Et) {
            ...
            var O = A.attachEvent,
                S = R !== bi;
            if (O) n.prepend(li(_n)), pt(n, N + _n)[0].attachEvent("onresize", u);else {
    ...
    function ni(n) {
      ...
      if (f && (Jt = setTimeout(ni, Xe)), !(Dt || f || $t && !u || Wt && !o && (t = nr.is(":hidden")) || "inline" === nr.css("display"))) {
        ...
        if (te = "n" === d, re = "s" === d, ee = "m" === d, ie = "l" === d, ne = s.autoHideDelay, Ur = Qr, oe = "n" === _, ue = "b" === _, fe = "h" === _, ae = "v" === _, Br = Gt.normalizeRTL, A = A && Tt.x && Tt.y, Dr = v, Mr = d, Fr = b, jr = m, Qr = y, Pr = _, Tr = S, Ar = k, Wr = I, Nr = A, Rr = E, Er = hi({}, N), $r = W, Yr = M, wr = wr || {
          x: !1,
          y: !1
        }, x && (pi(nr, Ur + Ie + Ve), di(nr, y !== bi && null !== y && 0 < y.length ? y : Ve)), L && (!0 === E || null === E && Et ? (Ge(), Ct.add(It)) : (Ct.remove(It), $e())), T) if (I) {
        ...
        if (Xr = On, un && (fn || z || X || dn.c || Y.c || vn.c) ? pn[_e] = ze : (fn || z) && (pn[ye + _e] = Se, pn[_e] = Ce), rn && (en || z || X || dn.c || Y.c || vn.c || V) ? (pn[xe] = ze, bn[ye + xe] = Ce) : (en || z) && (pn[ye + xe] = Se, pn[xe] = Ce, pn[Oe] = Se, bn[ye + xe] = Se), rn ? (dn.cw || (pn[ye + xe] = Se), bn[xe] = ze, pn[xe] = ze, pn[Oe] = G) : bn[xe] = Se, un ? (dn.ch || (pn[ye + _e] = Se), bn[_e] = zn.h || pr[gi.cH]) : bn[_e] = Se, I && fr.css(bn), or.css(pn), pn = {}, bn = {}, e || i || Sn || V || X || z || en || rn || fn || un || dn.c || H || R || C || O || h || p || w || g || D || F || Q) {
          ...
          if (Kn(!0), Kn(!1), qn.c = a(qn, Lr), Lr = qn, Xn.c = a(Xn, wr), wr = Xn, Yn.c = a(Yn, yr), yr = Yn, Tt.x || Tt.y) {
            var Jn,
                ...
                nt = {},
                tt = o;
            (Xn.x || Xn.y) && (nt.w = Tt.y && Xn.y ? jn.w + At.y : Se, nt.h = Tt.x && Xn.x ? jn.h + At.x : Se, tt = a(nt, mr), mr = nt), (Xn.c || Yn.c || jn.c || V || en || fn || rn || un || H) && (pn[ve + G] = pn[de + G] = Se, Jn = function Jn(n) {
              var t = ui(n),
                  r = ui(!n),
                  e = t.B,
                  i = n ? ge : $,
          ...
          if ((e || Xn.c || Yn.c || jn.c || R || X || H || V || C || fn) && (et[G] = Se, (rt = function rt(n) {
            var t = ui(n),
                r = ui(!n),
                e = t.B,
                i = t.G,
    ...
    function st(n) {
      ...
      return _typeof(e[r]) == wt ? n instanceof e[r] : n && _typeof(n) == wt && null !== n && 1 === n.nodeType && _typeof(n.nodeName) == _t;
    }
    ...
    function li(r, n) {
      return "<div " + (r ? cn(r) == _t ? 'class="' + r + '"' : function () {
        var n,
            t = Se;
        if (xi.isPlainObject(r)) for (n in r) {
          t += ("c" === n ? "class" : n) + '="' + r[n] + '" ';
        }
        return t;
      }() : Se) + ">" + (n || Se) + "</div>";
