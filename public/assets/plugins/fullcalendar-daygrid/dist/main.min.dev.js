...
*/
!function (e, t) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? t(exports, require("@fullcalendar/core")) : "function" == typeof define && define.amd ? define(["exports", "@fullcalendar/core"], t) : t((e = e || self).FullCalendarDayGrid = {}, e.FullCalendar);
}(void 0, function (e, t) {
  "use strict";
  ...
  var _i = function i() {
    ...
    return n(r, e), r.prototype.attachSegs = function (e, t) {
      ...
      function b(e) {
        for (; o < e;) {
          (d = (v[n - 1] || [])[o]) ? d.rowSpan = (d.rowSpan || 1) + 1 : (d = document.createElement("td"), s.appendChild(d)), y[n][o] = d, v[n][o] = d, o++;
        }
      }
      ...
      for (n = 0; n < f; n++) {
        if (i = u[n], o = 0, s = document.createElement("tr"), g.push([]), y.push([]), v.push([]), i) for (l = 0; l < i.length; l++) {
          ...
          }, a.el), S !== w ? d.colSpan = w - S + 1 : v[n][o] = d; o <= w;) {
            y[n][o] = d, g[n][o] = a, o++;
          }
  ...
  var h = function (e) {
    ...
    return n(r, e), r.prototype.renderSegs = function (t, r, n) {
      ...
      for (r = 0; r < t.length; r++) {
        n = t[r], i = this.renderFillRow(e, n), this.dayGrid.rowEls[n.row].appendChild(i), o.push(i);
      }
  ...
  var y = t.createFormatter({
    ...
    return n(r, e), r.prototype.render = function (e, t) {
      ...
      var n,
          ...
          R = function R(n) {
        for (; E < n;) {
          (a = v.getCellSegs(e, E, r)).length && (h = i[r - 1][E], y = v.renderMoreLink(e, E, a), g = t.createElement("div", null, y), h.appendChild(g), C.push(g)), E++;
        }
      };
  ...
  var C = function (e) {
    ...
    return n(t, e), t.prototype.firstContext = function (e) {
      ...
      var r = this.dayGrid,
          n = e.dateProfile,
          o = e.dayTable;
      r.receiveProps(_i({}, this.slicer.sliceProps(e, n, e.nextDayThreshold, t.calendar, r, o), {
        dateProfile: n,
        cells: o.cells,
        isRigid: e.isRigid
      }), t);
