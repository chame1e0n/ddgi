...
XRegExp = XRegExp || function (n) {
  ...
  function v(n, i, r) {
    ...
    for (u in _t.prototype) {
      _t.prototype.hasOwnProperty(u) && (n[u] = _t.prototype[u]);
    }
  ...
  function o(n, r, u) {
    if (!_t.isRegExp(n)) throw new TypeError("type RegExp expected");
    var f = i.replace.call(g(n) + (r || ""), h, "");
    return u && (f = i.replace.call(f, new RegExp("[" + u + "]+", "g"), "")), n = n.xregexp && !n.xregexp.isNative ? v(_t(n.source, f), n.xregexp.captureNames ? n.xregexp.captureNames.slice(0) : null) : v(new RegExp(n.source, f), null, !0);
  }
  ...
  function d(n) {
    return n = n || {}, n === "all" || n.all ? n = {
      natives: !0,
      extensibility: !0
    } : s(n, "string") && (n = _t.forEach(n, /[^\s,]+/, function (n) {
      this[n] = !0;
    }, {})), n;
  }
  ...
  function b(n) {
    _t.addToken = c[n ? "on" : "off"], f.extensibility = n;
  }
  ...
  return _t = function t(r, u) {
  ...
  }, _t.addToken = c.off, _t.cache = function (n, i) {
    var r = n + "/" + (i || "");
    return k[r] || (k[r] = _t(n, i));
  }, _t.escape = function (n) {
    return i.replace.call(n, /[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&");
  }, _t.exec = function (n, t, i, u) {
  ...
  }, _t.forEach = function (n, i, r, u) {
    for (var e = 0, o = -1, f; f = _t.exec(n, i, e);) {
      r.call(u, f, ++o, n, i), e = f.index + (f[0].length || 1);
    }

    return u;
  }, _t.globalize = function (n) {
    return o(n, "g");
  }, _t.install = function (n) {
    n = d(n), !f.natives && n.natives && tt(!0), !f.extensibility && n.extensibility && b(!0);
  }, _t.isInstalled = function (n) {
    return !!f[n];
  }, _t.isRegExp = function (n) {
    return s(n, "regexp");
  }, _t.matchChain = function (n, i) {
    return function r(n, u) {
      for (var o = i[u].regex ? i[u] : {
        ...
        _t.forEach(n[e], o.regex, s);
      }

      return u === i.length - 1 || !f.length ? f : r(f, u + 1);
    }([n], 0);
  }, _t.replace = function (i, u, f, e) {
    var c = _t.isRegExp(u),
        s = u,
        h;

    return c ? (e === n && u.global && (e = "all"), s = o(u, e === "all" ? "g" : "", e === "all" ? "" : "g")) : e === "all" && (s = new RegExp(_t.escape(String(u)), "g")), h = r.replace.call(String(i), s, f), c && u.global && (u.lastIndex = 0), h;
  }, _t.split = function (n, t, i) {
    return r.split.call(n, t, i);
  }, _t.test = function (n, i, r, u) {
    return !!_t.exec(n, i, r, u);
  }, _t.uninstall = function (n) {
    n = d(n), f.natives && n.natives && tt(!1), f.extensibility && n.extensibility && b(!1);
  }, _t.union = function (n, i) {
    ...
    for (u = 0; u < n.length; ++u) {
      r = n[u], _t.isRegExp(r) ? (f = o, h = r.xregexp && r.xregexp.captureNames || [], e.push(_t(r.source).source.replace(l, c))) : e.push(_t.escape(r));
    }

    return _t(e.join("|"), i);
  }, _t.version = "2.0.0", r.exec = function (t) {
    var r, f, e, o, u;
    ...
    if (this.global || (o = this.lastIndex), r = i.exec.apply(this, arguments), r) {
      ...
      })), this.xregexp && this.xregexp.captureNames) for (u = 1; u < r.length; ++u) {
    ...
    return e ? (n.xregexp && (u = n.xregexp.captureNames), n.global || (o = n.lastIndex)) : n += "", s(r, "function") ? f = i.replace.call(String(this), n, function () {
      var t = arguments,
          i;
      if (u) for (t[0] = new String(t[0]), i = 0; i < u.length; ++i) {
        u[i] && (t[0][u[i]] = t[i + 1]);
      }
    ...
    if (!_t.isRegExp(r)) return i.split.apply(this, arguments);
    var e = String(this),
        h = r.lastIndex,
        f = [],
        o = 0,
        s;
    return u = (u === n ? -1 : u) >>> 0, _t.forEach(e, r, function (n) {
    ...
    customFlags: "n"
  }), typeof exports != "undefined" && (exports.XRegExp = _t), _t;
...
})(XRegExp); //XRegExp Unicode Categories 1.2.0
...
})(XRegExp); //XRegExp Unicode Scripts 1.2.0
...
})(XRegExp); //XRegExp Unicode Blocks 1.2.0
...
})(XRegExp); //XRegExp Unicode Properties 1.0.0
...
})(XRegExp); //XRegExp.matchRecursive 0.2.0
...
(function (n) {
  ...
  n.matchRecursive = function (i, r, u, f, e) {
    ...
    for (;;) {
      if (y && (s += (n.exec(i, k, s, "sticky") || [""])[0].length), l = n.exec(i, r, s), a = n.exec(i, u, s), l && a && (l.index <= a.index ? a = null : l = null), l || a) h = (l || a).index, s = h + (l || a)[0].length;else if (!b) break;
      if (nt && !b && h > c) break;
      if (l) b || (p = h, w = s), ++b;else if (a && b) {
...
(function (n) {
  ...
  n.build = function (f, e, o) {
    ...
    for (c in e) {
      e.hasOwnProperty(c) && (a = t(e[c]), l[c] = {
        pattern: u(a.source),
...
})(XRegExp); //XRegExp Prototype Methods 1.0.0
