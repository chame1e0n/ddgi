  ...
  $.fn.actions = function (opts) {
    ...
    var showQuestion = function showQuestion() {
      ...
      $(options.actionContainer).removeClass(options.selectedClass);
        ...
        checker = function checker(checked) {
      if (checked) {
        showQuestion();
      } else {
        reset();
      ...
      var sel = $(actionCheckboxes).filter(":checked").length; // data-actions-icnt is defined in the generated HTML
    ...
    $(options.counterContainer).show(); // Check state of checkboxes and reinit state if needed
    ...
    $(actionCheckboxes).on('click', function (event) {
      ...
      if (lastChecked && $.data(lastChecked) !== $.data(target) && event.shiftKey === true) {
        var inrange = false;
        $(lastChecked).prop("checked", target.checked).parent().parent().toggleClass(options.selectedClass, target.checked);
        $(actionCheckboxes).each(function () {
          ...
          if (inrange) {
            $(this).prop("checked", target.checked).parent().parent().toggleClass(options.selectedClass, target.checked);
          }
        });
      }
