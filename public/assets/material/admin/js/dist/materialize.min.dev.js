...
window.cash = function () {
  ...
  function w(e) {
    return h(e) ? b : e.cash ? function (t) {
      return e.is(t);
    } : function (t, e) {
      return t === e;
    };
  ...
  Object.defineProperty(y, "constructor", {
    value: _
  }), _.parseHTML = f, _.noop = e, _.isFunction = l, _.isString = h, _.extend = y.extend = function (t) {
    t = t || {};
  ...
  y.extend({
    data: function data(e, i) {
      if (h(e)) {
        return i === undefined ? x(this[0], e) : this.each(function (t) {
          return O(t, e, i);
        });
      }
  ...
  y.extend({
    ...
    attr: function attr(e, i) {
      ...
      if (h(e)) {
        if (i === undefined) {
          return this[0] ? this[0].getAttribute ? this[0].getAttribute(e) : this[0][e] : undefined;
        }
    ...
    prop: function prop(e, i) {
      if (h(e)) {
        return i === undefined ? this[0][e] : this.each(function (t) {
          t[e] = i;
        });
      }
  ...
  _.prefixedProp = A, _.camelCase = I, y.extend({
    css: function css(e, i) {
      if (h(e)) {
        e = A(e);
        return arguments.length > 1 ? this.each(function (t) {
          return t.style[e] = i;
    ...
    y["outer" + e] = function (t) {
      return this[0]["offset" + e] + (t ? R(this, "margin" + (e === "Width" ? "Left" : "Top")) + R(this, "margin" + (e === "Width" ? "Right" : "Bottom")) : 0);
    };
  }), y.extend({
...
!function () {
  ...
  function y(t) {
    return b(t = t ? u(D.arr(t) ? t.map(o) : o(t)) : [], function (t, e, i) {
      return i.indexOf(t) === e;
    });
  }
  ...
  function k(t, i) {
    ...
    if (D.arr(t)) {
      var n = t.length;
      2 !== n || D.obj(t[0]) ? D.fnc(i.duration) || (e.duration = i.duration / n) : t = {
        value: t
      };
    }
    ...
    return o.tweens.map(function (t) {
      var e = (t = function (t, e) {
        ...
        return n.duration = parseFloat(n.duration), n.delay = parseFloat(n.delay), n;
          ...
          i = d(a.target, o.name),
          n = r ? r.to.original : i,
          s = (n = D.arr(e) ? e[0] : n, f(D.arr(e) ? e[1] : e, n));
  ...
  function n(t) {
    var e,
        ...
        a = c(L, t),
        r = c(T, t),
        l = (i = t.targets, (n = y(i)).map(function (t, e) {
      return {
        target: t,
        id: e,
        total: n.length
    ...
    for (e in t) {
      d.hasOwnProperty(e) || "targets" === e || h.push({
        name: e,
        offset: d.offset,
        tweens: k(t[e], r)
      });
    ...
    return o = h, p(a, {
      children: [],
      animatables: s = l,
      animations: t = b(u(s.map(function (n) {
  ...
  function x(t) {
    ...
    function c(e) {
      for (var t = 0, i = {}, n = k.animations, s = n.length; t < s;) {
        ...
        for (var l = Math.min(Math.max(e - r.start - r.delay, 0), r.duration) / r.duration, h = isNaN(l) ? 1 : r.easing(l, r.elasticity), d = (l = r.to.strings, r.round), u = [], c = void 0, p = (c = r.to.numbers.length, 0); p < c; p++) {
          var v = void 0,
              f = (v = r.to.numbers[p], r.from.numbers[p]);
          v = r.isPath ? C(r.value, h * v) : f + h * (v - f);
          d && (r.isColor && 2 < p || (v = Math.round(v * d) / d)), u.push(v);
        }

        if (r = l.length) for (c = l[0], h = 0; h < r; h++) {
          d = l[h + 1], p = u[h], isNaN(p) || (c = d ? c + (p + d) : c + (p + " "));
        } else c = u[0];
        A[o.type](a.target, o.property, c, i, a.id), o.currentValue = c, t++;
      }

      if (t = Object.keys(i).length) for (n = 0; n < t; n++) {
        B = B || (w(document.body, "transform") ? "transform" : "-webkit-transform"), k.animatables[n].target.style[B] = i[n].join(" ");
      }
  ...
  M.anime = (L = {
    ...
    elasticity: 500,
    round: 0
  }, $ = "translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX scaleY scaleZ skewX skewY perspective".split(" "), D = {
    arr: function arr(t) {
    ...
    return function (a, r, l, h) {
      if (0 <= a && a <= 1 && 0 <= l && l <= 1) {
        ...
        return function (t) {
          ...
          i = e + (t - d[--i]) / (d[i + 1] - d[i]) * .1;
          var n = 3 * (1 - 3 * l + 3 * a) * i * i + 2 * (3 * l - 6 * a) * i + 3 * a;
          ...
          if (.001 <= n) {
            ...
            for (var o = 0; 0 < (n = u(s = i + (e - i) / 2, a, l) - t) ? e = s : i = s, 1e-7 < Math.abs(n) && ++o < 10;) {
              ;
            }
    ...
    return n;
  }(), x.version = "2.2.0", x.speed = 1, x.running = R, x.remove = function (t) {
    t = y(t);
  ...
  }, x.getValue = d, x.path = function (t, e) {
  ...
  }, x.bezier = S, x.easings = I, x.timeline = function (n) {
    var s = x(n);
    return s.pause(), s.duration = 0, s.add = function (t) {
      return s.children.forEach(function (t) {
        ...
        var i = e.offset;
        e.autoplay = !1, e.direction = s.direction, e.offset = D.und(i) ? t : f(i, t), s.began = !0, s.completed = !0, s.seek(e.offset), (e = x(e)).began = !0, e.completed = !0, e.duration > t && (s.duration = e.duration), s.children.push(e);
  ...
  var t = {
    ...
    outDuration: 300
      ...
      e = (_inherits(s, Component), _createClass(s, [{
    key: "destroy",
    value: function value() {
  ...
  var t = {
    ...
    endingTop: "10%"
      ...
      e = (_inherits(n, Component), _createClass(n, [{
    key: "destroy",
    value: function value() {
  ...
  function s(t, e) {
    ...
    return (i.el.M_Parallax = i).options = n.extend({}, s.defaults, e), i._enabled = window.innerWidth > i.options.responsiveThreshold, i.$img = i.$el.find("img").first(), i.$img.each(function () {
  ...
  var t = {
    ...
    preventScrolling: !0
      ...
      e = (_inherits(o, Component), _createClass(o, [{
    key: "destroy",
    value: function value() {
    ...
    key: "open",
    value: function value() {
      !0 !== this.isOpen && (this.isOpen = !0, "function" == typeof this.options.onOpenStart && this.options.onOpenStart.call(this, this.el), this._isCurrentlyFixed() ? (n.remove(this.el), n({
        targets: this.el,
        translateX: 0,
        duration: 0,
        easing: "easeOutQuad"
    ...
    value: function value() {
      ...
      this.isDragged && (e = "left" === this.options.edge ? e + this.percentOpen : e - this.percentOpen), n.remove(this.el), n({
        targets: this.el,
        translateX: [100 * e + "%", 0],
        duration: this.options.inDuration,
        easing: "easeOutQuad",
    ...
    value: function value() {
      var t = this,
          e = "left" === this.options.edge ? -1 : 1,
          i = 0;
      this.isDragged && (i = "left" === this.options.edge ? e + this.percentOpen : e - this.percentOpen), n.remove(this.el), n({
        targets: this.el,
  ...
  function o(t, e) {
    ...
    var i = _possibleConstructorReturn(this, (o.__proto__ || Object.getPrototypeOf(o)).call(this, o, t, e));

    return (i.el.M_Sidenav = i).id = i.$el.attr("id"), i.options = s.extend({}, o.defaults, e), i.isOpen = !1, i.isFixed = i.el.classList.contains("sidenav-fixed"), i.isDragged = !1, i.lastWindowWidth = window.innerWidth, i.lastWindowHeight = window.innerHeight, i._createOverlay(), i._createDragTarget(), i._setupEventHandlers(), i._setupClasses(), i._setupFixed(), o._sidenavs.push(i), i;
  }
  ...
  var t = {
    ...
    getActiveElement: function getActiveElement(t) {
      ...
      e = (_inherits(c, Component), _createClass(c, [{
    key: "destroy",
    value: function value() {
  ...
  var t = {
    ...
    value: function value(t, i) {
      ...
      this.options.sortFunction && e.sort(function (t, e) {
  ...
  var t = {
    ...
    value: function value(t, e) {
      ...
      s(t).hasClass("center-align") ? i.translateY = -100 : s(t).hasClass("right-align") ? i.translateX = 100 : s(t).hasClass("left-align") && (i.translateX = -100), n(i);
    }
  }, {
    ...
    value: function value(t) {
      ...
      if (t >= this.$slides.length ? t = 0 : t < 0 && (t = this.$slides.length - 1), this.activeIndex != t) {
        ...
        this.$active.removeClass("active"), n({
        ...
        }), this._animateCaptionIn(i[0], this.options.duration), this.options.indicators && (this.$indicators.eq(this.activeIndex).removeClass("active"), this.$indicators.eq(t).addClass("active")), n({
  ...
  function o(t, e) {
    ...
    return (i.el.M_Slider = i).options = s.extend({}, o.defaults, e), i.$slider = i.$el.find(".slides"), i.$slides = i.$slider.children("li"), i.activeIndex = i.$slides.filter(function (t) {
  ...
  var t = {
    ...
    onChipDelete: null
      ...
      e = (_inherits(h, Component), _createClass(h, [{
    key: "getData",
    value: function value() {
    ...
    value: function value(t) {
      var e = l(t.target).closest(".chip"),
          i = l(t.target).is(".close");
    ...
    value: function value(t) {
      if (t.tag) {
        ...
        if (e.classList.add("chip"), e.textContent = t.tag, e.setAttribute("tabindex", 0), l(i).addClass("material-icons close"), i.textContent = "close", t.image) {
    ...
    key: "_setupInput",
    value: function value() {
      this.$input = this.$el.find("input"), this.$input.length || (this.$input = l("<input></input>"), this.$el.append(this.$input)), this.$input.addClass("input");
    }
  }, {
    key: "_setupLabel",
    value: function value() {
    ...
    key: "_setPlaceholder",
    value: function value() {
      void 0 !== this.chipsData && !this.chipsData.length && this.options.placeholder ? l(this.$input).prop("placeholder", this.options.placeholder) : (void 0 === this.chipsData || this.chipsData.length) && this.options.secondaryPlaceholder && l(this.$input).prop("placeholder", this.options.secondaryPlaceholder);
    }
  }, {
    key: "_isValid",
    value: function value(t) {
    ...
    value: function value(t) {
      if (this._isValid(t) && !(this.chipsData.length >= this.options.limit)) {
        ...
        this.$chips.add(e), this.chipsData.push(t), l(this.$input).before(e), this._setPlaceholder(), "function" == typeof this.options.onChipAdd && this.options.onChipAdd.call(this, this.$el, e);
      }
    }
  }, {
    key: "deleteChip",
    ...
    value: function value(t) {
      h._keydown || (l(t.target).closest(".chips")[0].M_Chips._selectedChip = null);
    }
  }, {
    key: "defaults",
    get: function get() {
  ...
  function h(t, e) {
    ...
    var i = _possibleConstructorReturn(this, (h.__proto__ || Object.getPrototypeOf(h)).call(this, h, t, e));

    return (i.el.M_Chips = i).options = l.extend({}, h.defaults, e), i.$el.addClass("chips input-field"), i.chipsData = [], i.$chips = l(), i._setupInput(), i.hasAutocomplete = 0 < Object.keys(i.options.autocompleteOptions).length, i.$input.attr("id") || i.$input.attr("id", M.guid()), i.options.data.length && (i.chipsData = i.options.data, i._renderChips(i.chipsData)), i.hasAutocomplete && i._setupAutocomplete(), i._setPlaceholder(), i._setupLabel(), i._setupEventHandlers(), i;
  }

  e._keydown = !1, M.Chips = e, M.jQueryLoaded && M.initializeJqueryWrapper(e, "chips", "M_Chips"), l(document).ready(function () {
  ...
  var t = {
    ...
    key: "_updateElements",
    value: function value() {
      for (var t in s._pushpins) {
        s._pushpins[t]._updatePosition();
      }
    }
  }, {
    key: "defaults",
  ...
  function s(t, e) {
    ...
    return (i.el.M_Pushpin = i).options = n.extend({}, s.defaults, e), i.originalOffset = i.el.offsetTop, s._pushpins.push(i), i._setupEventHandlers(), i._updatePosition(), i;
  }
  ...
  var e = (_inherits(s, Component), _createClass(s, [{
    key: "destroy",
    value: function value() {
  ...
  function s(t, e) {
    ...
    return (i.el.M_FloatingActionButton = i).options = r.extend({}, s.defaults, e), i.isOpen = !1, i.$anchor = i.$el.children("a").first(), i.$menu = i.$el.children("ul").first(), i.$floatingBtns = i.$el.find("ul .btn-floating"), i.$floatingBtnsReverse = i.$el.find("ul .btn-floating").reverse(), i.offsetY = 0, i.offsetX = 0, i.$el.addClass("direction-" + i.options.direction), "top" === i.options.direction ? i.offsetY = 40 : "right" === i.options.direction ? i.offsetX = -40 : "bottom" === i.options.direction ? i.offsetY = -40 : i.offsetX = 40, i._setupEventHandlers(), i;
  }
  ...
  var t = {
    ...
    onDraw: null
      ...
      e = (_inherits(B, Component), _createClass(B, [{
    key: "destroy",
    value: function value() {
    ...
    value: function value(t, e, i, n, s, o) {
      ...
      for (a = '<select class="datepicker-select orig-select-month" tabindex="-1">' + d.join("") + "</select>", h = g.isArray(u.yearRange) ? (l = u.yearRange[0], u.yearRange[1] + 1) : (l = i - u.yearRange, 1 + i + u.yearRange), d = []; l < h && l <= u.maxYear; l++) {
  ...
  var t = {
    ...
    onSelect: null
      ...
      e = (_inherits(f, Component), _createClass(f, [{
    key: "destroy",
    value: function value() {
  ...
  var t = {},
    ...
    key: "_setupCounter",
    value: function value() {
      this.counterEl = document.createElement("span"), n(this.counterEl).addClass("character-counter").css({
        "float": "right",
        "font-size": "12px",
        height: 1
    ...
    value: function value() {
      ...
      var i = e;
      t && (i += "/" + t, this._validateInput()), n(this.counterEl).html(i);
    }
  }, {
    key: "_validateInput",
    value: function value() {
  ...
  function s(t, e) {
    ...
    return (i.el.M_CharacterCounter = i).options = n.extend({}, s.defaults, e), i.isInvalid = !1, i.isValidLength = !1, i._setupCounter(), i._setupEventHandlers(), i;
  }
  ...
  var t = {
    ...
    onCycleTo: null
      ...
      e = (_inherits(i, Component), _createClass(i, [{
    key: "destroy",
    value: function value() {
  ...
  var t = {},
      i = (_inherits(s, Component), _createClass(s, [{
    key: "destroy",
    value: function value() {
    ...
    value: function value() {
      n(this.value).html(this.$el.val()), n(this.thumb).hasClass("active") || this._showRangeBubble();

      var t = this._calcRangeOffset();

      n(this.thumb).addClass("active").css("left", t + "px");
    }
  }, {
    key: "_handleRangeMousedownTouchstart",
    value: function value(t) {
      if (n(this.value).html(this.$el.val()), this._mousedown = !0, this.$el.addClass("active"), n(this.thumb).hasClass("active") || this._showRangeBubble(), "input" !== t.type) {
        var e = this._calcRangeOffset();

        n(this.thumb).addClass("active").css("left", e + "px");
      }
    }
  }, {
    ...
    value: function value() {
      if (this._mousedown) {
        ...
        n(this.thumb).addClass("active").css("left", t + "px"), n(this.value).html(this.$el.val());
      }
    }
  }, {
    ...
    value: function value() {
      if (!this._mousedown) {
        ...
        n(this.thumb).hasClass("active") && (e.remove(this.thumb), e({
          targets: this.thumb,
          height: 0,
          width: 0,
          top: 10,
    ...
    key: "_setupThumb",
    value: function value() {
      this.thumb = document.createElement("span"), this.value = document.createElement("span"), n(this.thumb).addClass("thumb"), n(this.value).addClass("value"), n(this.thumb).append(this.value), this.$el.after(this.thumb);
    }
  }, {
    key: "_removeThumb",
    value: function value() {
    ...
    value: function value() {
      var t = -7 + parseInt(n(this.thumb).parent().css("padding-left")) + "px";
  ...
  function s(t, e) {
    ...
    return (i.el.M_Range = i).options = n.extend({}, s.defaults, e), i._mousedown = !1, i._setupThumb(), i._setupEventHandlers(), i;
  }

  M.Range = i, M.jQueryLoaded && M.initializeJqueryWrapper(i, "range", "M_Range"), i.init(n("input[type=range]"));
}(cash, M.anime);