  ...
  !function (e) {
    ...
    var l = function l(e, t) {
      ...
      return t;
        ...
        q = function q(e) {
      var t = [];
      if (e.length) for (var n = e[0].getElementsByTagName("value"), r = 0; r < n.length; r++) {
      ...
      var t = new window.DOMParser().parseFromString(e, "text/xml"),
          n = [];
      if (t) for (var r = t.getElementsByTagName("field"), o = 0; o < r.length; o++) {
        var i = w(r[o]),
    ...
    var H = {
      ...
      merge: function e(t, n) {
        ...
        for (var o in n) {
          r.hasOwnProperty(o) && (Array.isArray(n[o]) ? r[o] = Array.isArray(t[o]) ? A(t[o].concat(n[o])) : n[o] : "object" == _typeof(n[o]) ? r[o] = e(t[o], n[o]) : r[o] = n[o]);
        }
    ...
    var u = function () {
      ...
      e.register = function (t, n, r) {
        ...
        var o = this.camelCase(e),
            a = "object" == _typeof(r) ? r[o] || r[e] : r;
        if (a) return a;
        var s = n.mi18n;
        return "object" == _typeof(s) && (s = s[o] || s[e]), s || (s = o), i.a.get(s, t);
      }, e.active = function (e) {
      ...
      var r = "function" == typeof Symbol && "symbol" == _typeof(Symbol.iterator) ? function (e) {
        ...
        return e.prototype.processConfig = function (e) {
          ...
          if (n) {
            var o = n.match(/\{[^}]+?\}/g),
                i = void 0;
            if (t && o) if ("object" === (void 0 === t ? "undefined" : r(t))) for (var a = 0; a < o.length; a++) {
    ...
    var r = n(0),
      ...
      function e(e, t) {
        ...
        this.preview = t, this.templates = {
          label: null,
          help: null,
          "default": function _default(e, t, r, i) {
      ...
      return c.build = function () {
        var e = this,
          ...
          input: function input(t) {
            ...
            if (0 == r.length) e.hideList(n);else {
