  ...
  !function (e) {
    ...
    var s = function s(e, t) {
      ...
      Array.isArray(t) || (t = [t]), t.forEach(function (t) {
        ...
        if ("object" == _typeof(t) && (n = t.type || (t.style ? "inline" : "href"), i = t.id, t = "inline" == n ? t.style : t.href, o = i || t.href || t.style), !L(o, "css")) {
          if ("href" == n) {
    ...
    var Q = {
      ...
      merge: function e(t, r) {
        ...
        for (var o in r) {
          n.hasOwnProperty(o) && (Array.isArray(r[o]) ? n[o] = Array.isArray(t[o]) ? E(t[o].concat(r[o])) : r[o] : "object" == _typeof(r[o]) ? n[o] = e(t[o], r[o]) : n[o] = r[o]);
        }
    ...
    var u = function () {
      ...
      e.register = function (t, r, n) {
        ...
        var o = this.camelCase(e),
            a = "object" == _typeof(n) ? n[o] || n[e] : n;
        if (a) return a;
        var l = r.mi18n;
        return "object" == _typeof(l) && (l = l[o] || l[e]), l || (l = o), i.a.get(l, t);
      }, e.active = function (e) {
      ...
      return document.dispatchEvent(f.a.loaded), o.actions = {
        ...
        toggleFieldEdit: function toggleFieldEdit(e) {
          (Array.isArray(e) ? e : [e]).forEach(function (e) {
            ["number", "string"].includes(_typeof(e)) && ("number" == typeof e ? e = h.stage.children[e].id : /^frmb-/.test(e) || (e = h.stage.querySelector(e).id), v.toggleEdit(e));
          });
        },
