                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="insurer-phone" name="tel_insurer" value="{{old('tel_insurer')}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="insurer-bill" class="col-form-label">Расчетный счет</label>
                                        <input type="text" id="insurer-bill" name="address_schet" value="{{old('address_schet')}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="insurer-type-activity" class="col-form-label">Вид
                                            деятельности</label>
                                        <input type="text" id="insurer-type-activity" name="active_type" value="{{old('active_type')}}"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="insurer-oked" name="oked_insurer" value="{{old('oked_insurer')}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
