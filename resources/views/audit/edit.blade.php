...
@section('content')
    <form action="{{ route('audit.update', $product->id) }}" method="POST" id="form-audit" enctype="multipart/form-data">
        @csrf
        @method('put')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="insurer-name" name="fio_insurer"
                                               value="{{$product->policyHolder->FIO}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="insurer-phone" name="tel_insurer"
                                               value="{{$product->policyHolder->phone_number}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="insurer-bill" class="col-form-label">Расчетный счет</label>
                                        <input type="text" id="insurer-bill" name="address_schet"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="insurer-type-activity" class="col-form-label">Вид
                                            деятельности</label>
                                        <input type="text" id="insurer-type-activity" name="active_type"
                                               value="{{$product->policyHolder->activity_type}}"
                                               class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="insurer-mfo" name="mfo_insurer"
                                               value="{{$product->policyHolder->mfo}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="insurer-bank" name="bank_insurer"
                                               value="{{$product->policyHolder->bank_id}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="insurer-inn" name="inn_insurer"
                                               value="{{$product->policyHolder->inn}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="insurer-okonh" name="okonh_insurer"
                                               value="{{$product->policyHolder->okonx}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="insurer-oked" name="oked_insurer"
                                               value="{{$product->policyHolder->oked}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="personal-info" class="form-control"
                                                  name="personal_info">{{$product->policyHolder->personal_info}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="other-payment-schedule"
                                ...
                                <div class="table-responsive p-0 " style="max-height: 300px;">
                                    <table class="table table-hover table-head-fixed" id="table-payment-schedule">
                                        ...
                                        @foreach($product->currencyTerms as $item)
                                            <tr id="payment-term-tr-${fieldNumber}" data-field-number="${fieldNumber}">
                                                <td><input type="hidden" value="{{ $item->id }}">
                                                    <input type="text" class="form-control" data-field="sum"
                                                           name="payment_sum[]" value="{{ $item->payment_sum }}" >
                                                </td>
                                                <td><input type="date" class="form-control" data-field="from"
                                                           name="payment_from[]" value="{{ $item->payment_from }}" >
                                                </td>
                                                <td>
                                                    <input type="button" value="Удалить" data-delte="{{$item->id}}" id="delete_terms" data-action="delete" class="btn btn-warning">
                                                </td>
                                            </tr>
                                        @endforeach
