    ...
    <script type="text/javascript">
        $(document).ready(function() {
            function calculation() {
                ...
                let contract_export_cargo_total = Number($('#contract-plural-export-cargo-shipped-goods-value').val()) +
                                                  Number($('#contract-plural-export-cargo-shipped-goods-paid').val()) +
                                                  Number($('#contract-plural-export-cargo-buyer-debt').val()) +
                                                  Number($('#contract-plural-export-cargo-overdue-amount-1-60').val()) +
                                                  Number($('#contract-plural-export-cargo-overdue-amount-60-180').val()) +
                                                  Number($('#contract-plural-export-cargo-paid-insurance-premium').val()) +
                                                  Number($('#contract-plural-export-cargo-penalty').val()) +
                                                  Number($('#contract-plural-export-cargo-other-expenses').val()) +
                                                  Number($('#contract-plural-export-cargo-shipped-goods-payment').val()) +
                                                  Number($('#contract-plural-export-cargo-unshipped-goods-payment').val())
