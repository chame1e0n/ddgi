...
@section('scripts')
    <script type="text/javascript">
        function counter() {
            var from = document.getElementById('policy-series-from').value;
            var to = document.getElementById('policy-series-to').value;
            var price = document.getElementById('policy-price').value;
