...
@section('content')
    <form action="{{route('gruz.store')}}" method="post" enctype="multipart/form-data" id="mainFormKasko">
        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="insurer-tel" name="email_insurer" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="card-body" id="beneficiary-card-body">
                                    <div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="beneficiary-tel" class="col-form-label">Почтовый адрес</label>
                                                    <input type="email" id="beneficiary-tel" name="email_beneficiary" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <div class="form-group">
                                                        <label for="dogovor-lizing-num" class="col-form-label">Номер поставки</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="geographic-zone" name="sending_point" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="geographic-zone">Пункт назначения</label>
                                                    <input type="text" id="geographic-zone" name="point_destination" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="geographic-zone" name="point_overloads" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="geographic-zone">Страны действия страхования</label>
                                                    <input type="text" id="geographic-zone" name="insurance_countries" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="geographic-zone">Местонахождение груза</label>
                                                    <input type="text" id="geographic-zone" name="location_of_cargo" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="geographic-zone" name="name_of_cargo" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="geographic-zone">Вид груза</label>
                                                    <input type="text" id="geographic-zone" name="type_of_cargo" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="geographic-zone">Вид упаковки</label>
                                                    <input type="text" id="geographic-zone" name="type_packaging" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="geographic-zone" name="weight_of_cargo" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="geographic-zone">Количество единиц груза</label>
                                                    <input type="text" id="geographic-zone" name="amount_of_cargo" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="geographic-zone">Вид транспорта</label>
                                                    <input type="text" id="geographic-zone" name="type_of_transport" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label for="beneficiary-name" class="col-form-label">Особенности груза</label>
                                                    <textarea id="beneficiary-name" name="qualities_of_cargo" class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-11">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>ФИО</label>
                                                                        <input name="fio_accompanying_main" type="text" class="form-control">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        <label>Должность</label>
                                                                        <input name="position_accompanying_main" type="text" class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-1">
                                                            <input style="margin-top: 32px;" type="button" id="addLitso" value="Добавить" class="btn btn-success product-fields-button">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="geographic-zone" name="amount_of_cargo_place" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="geographic-zone">Грузаперевозчик</label>
                                                    <input type="text" id="geographic-zone" name="transporter" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="geographic-zone">Наименование грузоотправителя</label>
                                                    <input type="text" id="geographic-zone" name="name_of_shipper" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="geographic-zone">Адрес грузоотправителя</label>
                                                    <input type="text" id="geographic-zone" name="address_shipper" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="geographic-zone" name="name_consignee" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="geographic-zone">Адрес грузополучателя</label>
                                                    <input type="text" id="geographic-zone" name="address_consignee" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input id="insurance_from" name="packaging_period_from" type="date" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <label class="col-form-label">Период упаковки  </label>
                                                <div class="input-group">
                                                    ...
                                                    <input id="insurance_from" name="packaging_period_to" type="date" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="icheck-success">
                                                            <input type="radio" name="condition_insurance" class="client-type-radio" id="radio-1" value="individual1">
                                                            <label for="radio-1">Не имеются</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="icheck-success">
                                                            <input type="radio" name="condition_insurance" class="client-type-radio" id="radio-2" value="individual">
                                                            <label for="radio-2">С ответственностью за все риски </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="icheck-success">
                                                            <input type="radio" name="condition_insurance" class="client-type-radio" id="radio-3" value="legal">
                                                            <label for="radio-3">С ответственностью за частную аварию </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="icheck-success">
                                                            <input type="radio" name="condition_insurance" class="client-type-radio" id="radio-4" value="legal1">
                                                            <label for="radio-4">Без ответственности за повреждения, кроме случаев крушения</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="file" multiple id="geographic-zone" name="accompanying_file" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        <div id="payment-terms-form">
                            ...
                            <div class="col-md-12">
                                <div class="icheck-success ">
                                    <input onchange="toggleBlock('tarif', 'data-tarif-descr')" class="form-check-input client-type-radio" type="checkbox" value="tariff" name="tariff" id="tarif">
                            ...
                            <div class="col-md-12">
                                <div class="icheck-success ">
                                    <input onchange="toggleBlock('preim', 'data-preim-descr')" class="form-check-input client-type-radio" type="checkbox" value="preim" name="preim" id="preim">
