        ...
        <section class="content">
            ...
            <div class="card card-info pretenziya" id="form-container">
                ...
                <div class="card-body">
                            ...
                            <div class="form-group col-sm-3">
                                ...
                                <select readonly id="pretensii-subsidiary" class="form-control" name="branch_id">
                                    <option selected="selected"
                                            value="{{$pretensii->branch_id}}">{{$pretensii->branch->name}}</option>
                                </select>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="input-group mb-4">
                                            <input type="number" class="form-control r-3-one-1-0"
                                                   name="insured_sum" value="{{$pretensii->insured_sum}}" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                <input type="number" class="form-control r-3-one-1-0"
                                                       ...
                                                       value="{{$pretensii->payable_by_agreement}}"
                                                       readonly>
                                                <div class="input-group-append">
                                                    <select class="form-control success"
                                                            style="width: 100%;"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input id="pretensii-last-payment-date" name="last_payment_date"
                                                       ...
                                                       readonly
                                                       value="{{$pretensii->last_payment_date}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class=" col-mb-3">
                                                ...
                                                <select class="form-control success" readonly name="franchise_type_id"
                                                        style="width: 100%;">
                                                    <option selected="selected"
                                                            value="{{$pretensii->franchise_type_id}}">{{$pretensii->franchise_type->type}}</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-4">
                                                <input type="text" size="3" name="franchise_percentage"
                                                       ...
                                                       value="{{$pretensii->franchise_percentage}}">
                                                <div class="input-group-append">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="pretensii-date-applications" name="date_applications" readonly
                                               type="date" class="form-control"
                                               value="{{$pretensii->date_applications}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="pretensii-date-of-occurrence-of-the-insured-event"
                                               ...
                                               readonly
                                               class="form-control" value="{{$pretensii->date_of_the_insured_event}}">
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group mb-4">
                                                    <input type="number" class="form-control r-3-one-1-0"
                                                           ...
                                                           readonly
                                                           value="{{$pretensii->refund_paid_sum}}">
                                                    <div class="input-group-append">
                                                        <select class="form-control success"
                                                                style="width: 100%;" readonly>
                                                            <option selected="selected">UZS</option>
                                            ...
                                            <div class=" col-md-6">
                                                ...
                                                <input type="text" name="total_amount_in_sums"
                                                       ...
                                                       readonly
                                                       value="{{$pretensii->total_amount_in_sums}}">
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-form-label"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="pretensii-final-settlement-date" name="final_settlement_date"
                                       value="{{$pretensii->final_settlement_date}}"
                                       readonly
                                       type="date" class="form-control">
                            </div>
                        </div>
                    ...
                    <form method="post" action="{{ route('pretensii_overview.store') }}">
                        @csrf
                        <input hidden value="{{$pretensii->id}}" name="pretensii_id">
                        <div class="form-group">
                            <label>Статус претензии</label>
                            <div class="row">
                                <div class="col-sm-4">
