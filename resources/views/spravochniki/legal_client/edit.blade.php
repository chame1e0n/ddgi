...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="content">
            <div class="container-fluid">
                <form method="post" action="{{ route('legal_client.store', $legalClient->id) }}"
                      id="client-client-form">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="name" class="form-control" name="name"
                                                       value="{{$legalClient->name}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="address" class="form-control" name="address"
                                                       value="{{$legalClient->address}}" required>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input id="phone_number" class="form-control" name="phone_number"
                                                       value="{{$legalClient->phone_number}}" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select id="bank_id" class="form-control" name="bank_id" required>
                                                    <option selected value="{{$legalClient->bank->id}}">{{$legalClient->bank->name}}</option>
                                                    @foreach($banks as $bank)
                                                        @if($legalClient->bank->id !== $bank->id)
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="schet" class="form-control" name="raschetniy_schet"
                                                       value="{{$legalClient->raschetniy_schet}}" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
