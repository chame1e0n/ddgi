                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input id="pretensii-final-settlement-date"
                                                       value="{{$policyRetransfer->act_number}}"
                                                       disabled
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="col-form-label" for="pretensii-final-settlement-date">Дата
                                                    акта</label>
                                                <input id="pretensii-final-settlement-date"
                                                       value="{{$policyRetransfer->act_date}}"
                                                       disabled
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="col-form-label" for="pretensii-final-settlement-date">Серия
                                                    бланка</label>
                                                    <input id="pretensii-final-settlement-date"
                                                           value="{{$policyRetransfer->policySeries->code}}"
                                                           disabled
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="col-form-label" for="pretensii-final-settlement-date">С
                                                    номера бланка</label>
                                                <input id="pretensii-final-settlement-date"
                                                       value="{{$policyRetransfer->policy_from}}"
                                                       disabled
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="col-form-label" for="pretensii-final-settlement-date">До
                                                    номера бланка</label>
                                                <input id="pretensii-final-settlement-date"
                                                       value="{{$policyRetransfer->policy_to}}"
                                                       disabled
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="col-form-label" for="pretensii-final-settlement-date">Кому
                                                    (филиал / офис)</label>
                                                <input id="pretensii-final-settlement-date"
                                                       value="{{$policyRetransfer->branch->name}}"
                                                       disabled
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input id="employee-tr"
                                                       value="@if(isset($policyRetransfer->user->agent->name)){{$policyRetransfer->user->agent->surname .' '. $policyRetransfer->user->agent->name .' '. $policyRetransfer->user->agent->middle_name .' - агент'}}@endif
                                                       @if(isset($policyRetransfer->user->manager->name)){{$policyRetransfer->user->manager->surname .' '. $policyRetransfer->user->manager->name .' '. $policyRetransfer->user->manager->middle_name .' - менеджер'}}@endif"
                                                       disabled
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="col-form-label" for="pretensii-final-settlement-date">Дата
                                                    распределения</label>
                                                <input id="pretensii-final-settlement-date"
                                                       value="{{$policyRetransfer->retransfer_distribution}}"
                                                       disabled
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="col-form-label" for="pretensii-final-settlement-date">Кто
                                                    выдал полис</label>
                                                <input id="pretensii-final-settlement-date"
                                                       value="{{$policyRetransfer->transfer_given}}"
                                                       disabled
