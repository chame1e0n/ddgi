                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="{{$page->policyHolders->phone_number}}" type="text" id="insurer-tel"
                                               name="tel_insurer"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" id="beneficiary-tel" name="passport_series" value="{{$page->policyHolders->passport_series}}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" id="beneficiary-tel" name="passport_number" value="{{$page->policyHolders->passport_number}}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="{{$page->policyHolders->checking_account}}" type="text" id="insurer-schet"
                                               name="address_schet"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="{{$page->policyHolders->oked}}" type="text" id="oked" name="oked"
                                               @if($errors->has('oked'))
                                               class="form-control is-invalid"
                                               @else
                                               class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly value="{{$page->policyBeneficiaries->FIO}}" type="text"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="beneficiary-address" class="col-form-label">Адрес
                                                        выгодоприобретателя</label>
                                                    <input readonly value="{{$page->policyBeneficiaries->address}}" type="text"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly value="{{$page->policyBeneficiaries->phone_number}}" type="text"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="insurer-tel" class="col-form-label">Серия
                                                        паспорта</label>
                                                    <input readonly type="text" id="insurer-tel" name="seria_passport" class="
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="insurer-schet" class="col-form-label">Номер
                                                        паспорта</label>
                                                    <input readonly type="text" id="insurer-schet" name="nomer_passport" class="
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly value="{{$page->policyBeneficiaries->checking_account}}" type="text" id="beneficiary_schet"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly value="{{$page->policyBeneficiaries->mfo}}" type="text" id="mfo_beneficiary"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly value="{{$page->policyBeneficiaries->inn}}" type="number" id="inn_beneficiary"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly value="{{$page->policyBeneficiaries->oked}}" type="text" id="oked_beneficiary"
