                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               id="insurer-name"
                                               name="fio_insurer"
                                               value="{{$tamozhnya->policyHolders->FIO}}"
                                               required
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$tamozhnya->policyHolders->address}}"
                                               type="text"
                                               id="insurer-address"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$tamozhnya->policyHolders->phone_number}}"
                                               type="text"
                                               id="insurer-tel"
                                               name="tel_insurer"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$tamozhnya->policyHolders->checking_account}}"
                                               type="text"
                                               id="insurer-schet"
                                               name="address_schet"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$tamozhnya->policyHolders->inn}}"
                                               type="text"
                                               id="insurer-inn"
                                               name="inn_insurer"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$tamozhnya->policyHolders->mfo}}"
                                               type="text"
                                               id="insurer-mfo"
                                               name="mfo_insurer"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$tamozhnya->policyHolders->oked}}"
                                               type="text"
                                               id="oked"
                                               name="oked"
                                               @if($errors->has('oked'))
