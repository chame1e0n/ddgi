                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="checkbox icheck-success">
                                                            <input id="defects-1" type="radio" class="pretenzii_in_ruz" name="pretenzii_in_ruz" value="1">
                                                            <label for="defects-1">Да</label>
                                                        </div>
                                                        <div class="checkbox icheck-success ">
                                                            <input id="defects-0" type="radio" class="pretenzii_in_ruz" name="pretenzii_in_ruz" value="0">
