                    ...
                    <div class="card-body">
                        <div id="client-product-form">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="icheck-success">
                                            <input type="radio" value="" name="client_type_radio" class="client-type-radio" id="client-type-radio-1" value="individual">
                                            <label for="client-type-radio-1">физ. лицо</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="icheck-success">
                                            <input type="radio" value="" name="client_type_radio" class="client-type-radio" id="client-type-radio-2" value="legal">
                            ...
                            <div class="form-group">
                                ...
                                <select id="product-id" class="form-control select2" value="" name="product_id" style="width: 100%;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="beneficiary-name" value="{{$page->PolicyBeneficiaries->FIO}}"value="" name="fio_beneficiary" @if($errors->has('fio_beneficiary'))
                                                class="form-control is-invalid"
                                                       @else
                                                       class="form-control"
                                                    @endif>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="beneficiary-address" class="col-form-label">Юр адрес
                                                    выгодоприобретателя</label>
                                                <input type="text" id="beneficiary-address" value="{{$page->PolicyBeneficiaries->address}}"value="" name="address_beneficiary" @if($errors->has('address_beneficiary'))
                                                class="form-control is-invalid"
                                                       @else
                                                       class="form-control"
                                                    @endif>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="beneficiary-tel" value="{{$page->PolicyBeneficiaries->phone_number}}"value="" name="tel_beneficiary" @if($errors->has('tel_beneficiary'))
                                                class="form-control is-invalid"
                                                       @else
                                                       class="form-control"
                                                    @endif>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="beneficiary-schet" value="{{$page->PolicyBeneficiaries->checking_account}}"value="" name="beneficiary_schet" @if($errors->has('beneficiary_schet'))
                                                class="form-control is-invalid"
                                                       @else
                                                       class="form-control"
                                                    @endif>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="beneficiary-inn" value="{{$page->PolicyBeneficiaries->inn}}"value="" name="inn_beneficiary" @if($errors->has('inn_beneficiary'))
                                                class="form-control is-invalid"
                                                       @else
                                                       class="form-control"
                                                    @endif>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="beneficiary-mfo" value="{{$page->PolicyBeneficiaries->mfo}}"value="" name="mfo_beneficiary" @if($errors->has('mfo_beneficiary'))
                                                class="form-control is-invalid"
                                                       @else
                                                       class="form-control"
                                                    @endif>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="beneficiary-okonh" value="{{$page->PolicyBeneficiaries->okonx}}" name="okonx_beneficiary" @if($errors->has('okonx_beneficiary'))
                                                class="form-control is-invalid"
                                                       @else
                                                       class="form-control"
                                                    @endif>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input id="insurance_from" value="{{$page->insurance_from}}"value="" name="insurance_from" type="date" @if($errors->has('insurance_from'))
                                                class="form-control is-invalid"
                                                       @else
                                                       class="form-control"
                                                    @endif>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3" style="margin-top: 33px">
                                                ...
                                                <input id="insurance_to" value="{{$page->insurance_to}}" value="" name="insurance_to" type="date" @if($errors->has('insurance_to'))
                                                class="form-control is-invalid"
                                                       @else
                                                       class="form-control"
                                                    @endif>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-inline justify-content-between">
                                        ...
                                        <select value="" name="insurance_premium_currency" @if($errors->has('insurance_premium_currency'))
                                        class="form-control is-invalid"
                                                @else
                                                class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="geographic-zone" value="" name="anketa" @if($errors->has('anketa'))
                                        class="form-control is-invalid"
                                               @else
                                               class="form-control"
                                            @endif>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="geographic-zone" value="" name="dogovor" @if($errors->has('dogovor'))
                                        class="form-control is-invalid"
                                               @else
                                               class="form-control"
                                            @endif>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="geographic-zone" value="" name="polis" @if($errors->has('polis'))
                                        class="form-control is-invalid"
                                               @else
                                               class="form-control"
                                            @endif>
