...
@section('content')
    ...
    <form action="GET" id="formBrokers">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <textarea class="form-control" id="public-sector" name="public-sector-comment"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <textarea id="private-sector" class="form-control" name="private-sector-comment"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <textarea class="form-control" name="reason-case"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="input-group mb-3">
                                            ...
                                            <textarea class="form-control" name="reason-administrative-case"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
