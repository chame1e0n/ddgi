                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="insurer-address" class="col-form-label">Юр адрес
                                            страхователя</label>
                                        <input readonly value="{{$page->policyHolders->address}}" type="text" id="insurer-address"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="{{$page->policyHolders->phone_number}}" type="text" id="insurer-phone"
                                               name="tel_insurer"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="{{$page->policyHolders->checking_account}}" type="text" id="insurer-bill"
                                               name="address_schet"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" id="insurer-type-activity" name="vid_deyatelnosti" value="{{$page->policyHolders->vid_deyatelnosti}}" @if($errors->has('vid_deyatelnosti'))
                                        class="form-control is-invalid"
                                               @else
                                               class="form-control"
                                            @endif>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="{{$page->policyHolders->mfo}}"  type="text" id="insurer-mfo" name="mfo_insurer"@if($errors->has('mfo_insurer'))
                                        class="form-control is-invalid"
                                               @else
                                               class="form-control"
                                            @endif >
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="{{$page->policyHolders->inn}}" type="text" id="insurer-inn"
                                               name="inn_insurer"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="{{$page->policyHolders->okonx}}" type="text" id="insurer-okonh" name="okonx"
                                               @if($errors->has('okonx'))
                                               class="form-control is-invalid"
                                               @else
                                               class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly value="{{$page->policyHolders->oked}}" type="text" id="insurer-oked" name="oked"
                                               @if($errors->has('oked'))
                                               class="form-control is-invalid"
                                               @else
                                               class="form-control"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input readonly value="{{$page->insurance_from}}" id="insurance_from" name="insurance_from" type="date"
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="input-group mb-3" style="margin-top: 33px">
                                                    ...
                                                    <input readonly value="{{$page->insurance_to}}" id="insurance_to" name="insurance_to" type="date"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input readonly value="{{$page->geo_zone}}" type="text" id="geo_zone" name="geo_zone"
                                    ...
                                    <table class="table table-hover table-head-fixed" id="empTable">
                                        ...
                                        @foreach($page->infos as $info)
                                            <tr>
                                                ...
                                                <td>
                                                    <select readonly="" class="form-control polises" id="polises" name="policy_series_id[]" style="width: 100%;">
                                                ...
                                                <td>
                                                    <input readonly type="date" class="form-control" name="from_date_polis[]" value="{{$info->from_date_polis}}">
                                                </td>
                                                <td>
                                                    <input readonly type="date" class="form-control" name="to_date_polis[]" value="{{$info->to_date_polis}}">
                                                </td>
                                                <td>
                                                    <select readonly="" class="form-control polises" id="polises" name="agent_id[]" style="width: 100%;">
                                                ...
                                                <td>
                                                    <input readonly type="text" class="form-control" name="insurer_fio[]" value="{{$info->insurer_fio}}">
                                                </td>
                                                <td>
                                                    <input readonly type="text" class="form-control" name="specialty[]"  value="{{$info->specialty}}">
                                                </td>
                                                <td>
                                                    <input readonly type="text" class="form-control" name="experience[]" value="{{$info->experience}}">
                                                </td>
                                                <td>
                                                    <input readonly type="text" class="form-control" name="position[]"  value="{{$info->position}}">
                                                </td>
                                                <td>
                                                    <input readonly type="text" class="form-control" name="time_stay[]" value="{{$info->time_stay}}">
                                                </td>
                                                <td>
                                                    <input readonly type="text" data-field="value" class="form-control" name="insurer_price[]" value="{{$info->insurer_price}}">
                                                </td>
                                                <td>
                                                    <input readonly type="text" data-field="sum" class="form-control" name="insurer_sum[]" value="{{$info->insurer_sum}}">
                                                </td>
                                                <td>
                                                    <input readonly type="text" data-field="premiya" class="form-control" name="insurer_premium[]" value="{{$info->insurer_premium}}">
                                                </td>
                                            </tr>
                                        @endforeach
                                        <tr>
                                            <td colspan="10" style="text-align: right"><label class="text-bold">Итого</label></td>
                                            <td><input readonly readonly type="text" data-insurance-stoimost class="form-control overall-sum2" style="cursor: pointer"/>
                                            </td>
                                            <td><input readonly readonly type="text" data-insurance-sum class="form-control overall-sum4" style="cursor: pointer"/>
                                            </td>
                                            <td><input readonly readonly type="text" data-insurance-award class="form-control overall-sum3" style="cursor: pointer"/>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div id="product-fields" class="product-fields">
                                <table class="table table-hover table-head-fixed" data-annual-turnover-info>
                                    ...
                                    <tr>
                                        ...
                                        <td><input readonly readonly type="text" data-total-turnover class="form-control overall-sum4" value="{{$page->total_turnover}}" style="cursor: pointer"/>
                                        </td>
                                        <td><input readonly readonly type="text" data-earnings class="form-control overall-sum3" value="{{$page->total_profit}}" style="cursor: pointer"/>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input readonly data-activity-period="from" name="activity_period_from" type="date" class="
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            <div class="input-group mb-3" style="margin-top: 33px">
                                                ...
                                                <input readonly data-activity-period="to" name="activity_period_to" type="date" class="
                                ...
                                <div class="form-group">
                                    ...
                                    <input readonly readonly data-total="total-active-org" type="text" class="
                ...
                <div class="card-body" id="fields-changed">
                    <div id="product-fields-0-3">
                                ...
                                <div class="row">
                                    <div class="col-sm-1">
                                        <div class="checkbox icheck-success">
                                            <input readonly type="radio" class="other_insurance-0" name="acted" data-acted-radio id="success-action-1" value="1" @if($page->public_sector_comment || $page->private_sector_comment) checked @endif>
                                            <label for="success-action-1">Да</label>
                                        </div>
                                        <div class="checkbox icheck-success">
                                            <input readonly type="radio" class="other_insurance-0" name="acted" data-acted-radio id="success-action-2" value="0" @if(!$page->public_sector_comment || !$page->private_sector_comment) checked @endif>
                        ...
                        <div class="form-group">
                            ...
                            <input readonly type="text" id="geographic-zone" name="prof_riski" class="form-control" value="{{$page->prof_riski}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-1">
                                    <div class="checkbox icheck-success">
                                        <input readonly type="radio" class="other_insurance-0" data-cases-radio name="cases" id="case-true" value="1" @if($page->reason_case) checked @endif>
                                        <label for="case-true">Да</label>
                                    </div>
                                    <div class="checkbox icheck-success">
                                        <input readonly type="radio" class="other_insurance-0" data-cases-radio name="cases" id="case-false" value="0" @if(!$page->reason_case) checked @endif>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-1">
                                    <div class="checkbox icheck-success">
                                        <input readonly type="radio" class="other_insurance-0" data-administr-radio name="administrative-case" id="case-administrative-1" value="1" @if($page->reason_administrative_case) checked @endif>
                                        <label for="case-administrative-1">Да</label>
                                    </div>
                                    <div class="checkbox icheck-success">
                                        <input readonly type="radio" class="other_insurance-0" data-administr-radio name="administrative-case" id="case-administrative-2" value="0" @if(!$page->reason_administrative_case) checked @endif>
                        ...
                        <div class="form-group form-inline justify-content-between">
                            ...
                            <select readonly="" required class="form-control payment-schedule" data-select-id="1" name="sfera_deyatelnosti" style="width: 100%; text-align: center">
                        ...
                        <div class="form-group form-inline justify-content-between">
                            ...
                            <select readonly="" class="form-control payment-schedule" data-select-id="3" name="limit_otvetstvennosti" style="width: 100%; text-align: center">
                        ...
                        <div class="form-group">
                            ...
                            <input readonly class="form-control" data-file="file" type="file" multiple name="documents[]">
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group form-inline justify-content-between">
                                            ...
                                            <select readonly="" name="insurance_premium_currency" class="form-control" data-wallet="wallet" id="walletNames" style="width: 100%; text-align: center">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group form-inline justify-content-between">
                                            ...
                                            <select readonly="" class="form-control payment-schedule" data-payment="payment" id="payment-procedure" name="poryadok_oplaty_premii" style="width: 100%; text-align: center">
                                        ...
                                        <table class="table table-hover table-head-fixed" id="table-payment-schedule">
                                            ...
                                            @foreach($page->strahPremiya as $prem)
                                                <tr id="payment-term-tr-0" data-field-number="0">
                                                    <td><input readonly type="text" class="form-control" name="payment_sum[]" value="{{$prem->prem_sum}}">
                                                    </td>
                                                    <td><input readonly type="date" class="form-control" name="payment_from[]" value="{{$prem->prem_from}}">
                                                    </td>
                                                    <td>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly type="text" id="all-summ" name="strahovaya_sum" class="form-control" value="{{$page->strahovaya_sum}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="all-summ">Франшиза</label>
                                        <input readonly type="text" id="all-frnshiza" name="franshiza" class="form-control" value="{{$page->franshiza}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="all-premia">Страховая премия</label>
                                        <input readonly type="text" id="all-premia" name="strahovaya_purpose" class="form-control" value="{{$page->strahovaya_purpose}}" >
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select readonly="" type="text" id="serial_number_policy" name="serial_number_policy" @if($errors->has('serial_number_policy'))
                                                class="form-control is-invalid"
                                                        @else
                                                        class="form-control"
                                                    @endif>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select readonly="" @if($errors->has('otvet_litso'))
                                                        class="form-control is-invalid"
                                                        @else
                                                        class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <input readonly id="anketa" name="anketa" value="{{old('anketa')}}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <input readonly id="dogovor" name="dogovor" value="{{old('dogovor')}}"
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @endif
                                            <input readonly id="polis" name="polis" value="{{old('polis')}}"
                    ...
                    <div id="product-fields-0-7">
                        <table class="table table-hover table-head-fixed">
                            ...
                            <tr>
                                ...
                                <td><input readonly type="number" class="form-control r-3-pass-0" readonly value="1" name="driver_quantity"></td>
                                <td>
                                    <div class="input-group mb-4">
                                        <input readonly type="text" class="form-control r-3-one-0" name="driver_one_sum">
                                        <div class="input-group-append">
                                            <select readonly="" class="form-control success" name="driver_currency" style="width: 100%;">
                                ...
                                <td><input readonly type="number" class="form-control r-3-sum-0" name="driver_total_sum" id="driver_total_sum-0">
                                </td>
                                <td><input readonly type="number" class="form-control r-3-premia-0" name="driver_preim_sum" id="driver_total_sum-0">
                                </td>
                            </tr>
                            <tr>
                                <td><label>Пассажиры</label></td>
                                <td><input readonly type="number" class="form-control r-3-pass-1-0" name="passenger_quantity"></td>
                                <td>
                                    <div class="input-group mb-4">
                                        <input readonly type="text" class="form-control r-3-one-1-0" name="passenger_one_sum">
                                        <div class="input-group-append">
                                ...
                                <td><input readonly type="number" class="form-control r-3-sum-1-0" name="passenger_total_sum" id="passenger_total_sum-0"></td>
                                <td><input readonly type="number" class="form-control r-3-premia-1-0" name="passenger_preim_sum" id="passenger_total_sum-0"></td>
                            </tr>
                            <tr>
                                <td><label class="text-bold">Общий Лимит</label>
                                </td>
                                <td><input readonly type="number" class="form-control r-3-pass-2-0" name="limit_quantity"></td>
                                <td>
                                    <div class="input-group mb-4">
                                        <input readonly type="text" class="form-control r-3-one-2-0" name="limit_one_sum">
                                        <div class="input-group-append">
                                ...
                                <td><input readonly type="number" class="form-control r-3-sum-2-0" name="limit_total_sum"></td>
                                <td><input readonly type="number" class="form-control r-3-premia-2-0" name="limit_preim_sum"></td>
                            </tr>
                            <tr>
                                <td colspan="3"><label class="text-bold">Итого</label>
                                </td>
                                <td><input readonly type="number" class="form-control r-summ-0">
                                </td>
                                <td><input readonly type="number" class="form-control r-summ-premia-0"></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
