...
@section('content')
    <form action="{{route('avtocredit.update', $all_product->id)}}" method="post" enctype="multipart/form-data" id="mainFormKasko">
        @csrf
        @method('put')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="insurer-address" class="col-form-label">Юр адрес
                                            страхователя</label>
                                        <input type="text" id="insurer-address" name="address_insurer" value="{{$all_product->policyHolder->address}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="insurer-tel" class="col-form-label">Телефон</label>
                                        <input type="text" id="insurer-tel" name="phone_insurer" value="{{$all_product->policyHolder->phone_number}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="insurer-schet" class="col-form-label">Расчетный счет</label>
                                        <input type="text" id="insurer-schet" name="address_schet" value="{{$all_product->policyHolder->checking_account}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="insurer-inn" class="col-form-label">ИНН</label>
                                        <input type="text" id="insurer-inn" name="inn_insurer" value="{{$all_product->policyHolder->inn}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="insurer-mfo" class="col-form-label">МФО</label>
                                        <input type="text" id="insurer-mfo" name="mfo_insurer" value="{{$all_product->policyHolder->mfo}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="insurer-bank" class="col-form-label">Банк</label>
                                        <input type="text" id="insurer-bank" name="bank_insurer" value="{{$all_product->policyHolder->bank_id}}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="insurer-okonh" class="col-form-label">ОКЭД</label>
                                        <input type="text" id="insurer-okonh" name="oked_insurer" value="{{$all_product->policyHolder->oked}}" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="beneficiary-name" name="fio_beneficiary" value="{{$all_product->zaemshik->z_fio}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="beneficiary-address" class="col-form-label">Адрес
                                                        заемщика</label>
                                                    <input type="text" id="beneficiary-address" name="address_beneficiary" value="{{$all_product->zaemshik->z_address}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="beneficiary-tel" class="col-form-label">Телефон</label>
                                                    <input type="text" id="beneficiary-tel" name="tel_beneficiary" value="{{$all_product->zaemshik->z_phone}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="beneficiary-tel" class="col-form-label">Серия
                                                        паспорта</label>
                                                    <input type="text" id="beneficiary-tel" name="passport_series" value="{{$all_product->zaemshik->passport_series}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="beneficiary-tel" class="col-form-label">Номер
                                                        паспорта</label>
                                                    <input type="text" id="beneficiary-tel" name="passport_number" value="{{$all_product->zaemshik->passport_number}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="beneficiary-schet" class="col-form-label">Расчетный
                                                        счет</label>
                                                    <input type="text" id="beneficiary-schet" name="beneficiary_schet" value="{{$all_product->zaemshik->z_checking_account}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="beneficiary-inn" class="col-form-label">ИНН</label>
                                                    <input type="text" id="beneficiary-inn" name="inn_beneficiary" value="{{$all_product->zaemshik->z_inn}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="beneficiary-mfo" class="col-form-label">МФО</label>
                                                    <input type="text" id="beneficiary-mfo" name="mfo_beneficiary" value="{{$all_product->zaemshik->z_mfo}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="beneficiary-bank" class="col-form-label">Банк</label>
                                                    <input type="text" id="beneficiary-bank" name="bank_beneficiary" value="{{$all_product->zaemshik->bank_id}}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="beneficiary-okonh" class="col-form-label">ОКЭД</label>
                                                    <input type="text" id="beneficiary-okonh" name="oked_beneficiary" value="{{$all_product->zaemshik->z_oked}}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label for="dogovor-lizing-num" class="col-form-label">Кредитный договор
                                                    №</label>
                                                <input type="text" id="dogovor-lizing-num" name="dogovor_lizing_num" value="{{$all_product->dogovor_lizing_num}}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="insurance_from" name="credit_from" value="{{$all_product->credit_from}}" type="date" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="col-form-label">Срок кредитования</label>
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input id="insurance_to" name="credit_to" value="{{$all_product->credit_to}}" type="date" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="geographic-zone" name="sum_of_credit" value="{{$all_product->sum_of_credit}}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input id="insurance_from" name="insurance_from" value="{{$all_product->insurance_from}}" type="date" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="input-group mb-3" style="margin-top: 33px">
                                                ...
                                                <input id="insurance_to" name="insurance_until" value="{{$all_product->insurance_until}}" type="date" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="geographic-zone" name="credit_franchise" value="{{$all_product->credit_franchise}}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control polises" id="polises" name="currency_of_settlement" style="width: 100%;">
                                            <option @if($all_product->currency_of_settlement == '0') selected="selected" @endif  value="0"></option>
                                            <option @if($all_product->currency_of_settlement == '1') selected="selected" @endif value="1">UZS</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="payment-terms-form">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-inline justify-content-between">
                                        ...
                                        <select class="form-control" id="walletNames"
                                            ...
                                            <option @if($all_product->insurance_premium_currency =='1')  selected @endif value="1">UZS
                                            </option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group" data-tarif-descr @if($all_product->tariff !== 'tariff') style="display: none" @endif>
                                    ...
                                    <input class="form-control" id="descrTarif" name="tariff_other" value="{{$all_product->tarif_other}}" type="number">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="icheck-success ">
                                ...
                                <div class="form-group" data-preim-descr @if($all_product->preim !== 'preim') style="display: none" @endif>
                                    ...
                                    <input class="form-control" id="descrPreim" name="premiya_other" value="{{$all_product->premiya_other}}" type="number">
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="polis-series" class="col-form-label">Серийный номер полиса
                                                страхования</label>
                                            <input type="text" id="polis-series" name="policy_series" value="{{$all_product->allProductInfo->policy_series}}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="insurance_from" name="policy_insurance_from" value="{{$all_product->allProductInfo->policy_insurance_from}}" type="date" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
