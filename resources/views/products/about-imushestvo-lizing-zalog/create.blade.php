                        ...
                        <div id="client-product-form">
                            ...
                            <div class="form-group">
                                ...
                                <select id="product-id" class="form-control select2" name="product_id"
                                        style="width: 100%;">
                                    <option selected="selected">ИМУЩЕСТВО ПЕРЕДАВАЕМОЕ В ЛИЗИНГ/ЗАЛОГ</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="table-responsive p-0 " style="max-height: 300px;">
                            <div id="product-fields" class="product-fields" data-field-number="0">
                                <table class="table table-hover table-head-fixed" id="empTable">
                                    ...
                                    <tr>
                                        <td colspan="4" style="text-align: right"><label class="text-bold">Итого</label>
                                        </td>
                        ...
                        <div class="card card-info" id="clone-beneficiary">
                            ...
                            <div class="card-body" id="beneficiary-card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="geographic-zone">% от страховой суммы по другим рискам по
                                                каждому
                                                    ...
                                                    <table class="table table-hover table-head-fixed">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number"
                                                                       class="form-control r-summ-premia-0">
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
