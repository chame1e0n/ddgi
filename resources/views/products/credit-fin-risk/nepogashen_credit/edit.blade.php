...
@section('content')
    ...
    <form action="{{route('nepogashen-credit.update', $page->id)}}" id="mainFormKasko" method="POST">
        @method('PUT')
        @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="other_forms" value="{{$page->other_forms}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="total_sum" value="{{$page->total_sum}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="total_award" value="{{$page->total_award}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
