                            ...
                            <div class="col-sm-12">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="form-group">
                                                <label for="dogovor_lizing_num" class="col-form-label">Кредитный договор</label>
                                                <input type="text" id="dogovor_lizing_num" name="dogovor_lizing_num" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="insurance_from" name="data_delivery_policy" type="date" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control polises" id="otvet-litso" name="agent_id" style="width: 100%;">
                                                ...
                                                <option name="agent_id" selected="selected" value="{{$agent->id}}">{{$agent->getFi()}}</option>
                                                    @endforeach
                                            </select>
                                        </div>
                                    </div>
