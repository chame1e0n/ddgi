                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="beneficiary-tel" name="passport_beneficiary" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="beneficiary-tel" class="col-form-label">Номер паспорта</label>
                                                    <input type="text" id="beneficiary-tel" name="passport_num_beneficiary" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <textarea id="dogovor-lizing-num" name="other_info" class="form-control"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
