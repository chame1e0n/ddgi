                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               id="policy-holder-fio"
                                               value="{{$all_product->policyHolder->FIO}}"
                                               name="policy_holder[FIO]"
                                               class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               id="policy-holder-address"
                                               value="{{$all_product->policyHolder->address}}"
                                               name="policy_holder[address]"
                                               class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               id="policy-holder-phone-number"
                                               value="{{$all_product->policyHolder->phone_number}}"
                                               name="policy_holder[phone_number]"
                                               class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               id="policy-holder-checking-account"
                                               value="{{$all_product->policyHolder->phone_number}}"
                                               name="policy_holder[checking_account]"
                                               class="form-control" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               id="policy-holder-inn"
                                               name="policy_holder[inn]"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               id="policy-holder-mfo"
                                               name="policy_holder[mfo]"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               id="policy-holder-oked"
                                               name="policy_holder[oked]"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               id="policy-holder-okonx"
                                               name="policy_holder[okonx]"
