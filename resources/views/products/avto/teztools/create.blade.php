...
{{--@endsection--}}
@section('content')
    <form action="{{route('teztools.store')}}" method="post" enctype="multipart/form-data" id="mainFormKasko">
        @csrf
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="beneficiary-name" class="col-form-label">Наименования
                                            страхователя</label>
                                        <input type="text" id="beneficiary-name" name="fio_insurer"
                                               class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="beneficiary-okonh" class="col-form-label">Номер
                                                паспорта</label>
                                            <input type="text" id="beneficiary-okonh" name="nomer_passport"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="beneficiary-okonh" name="seria_passport"
                                                   class="form-control">
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="icheck-success ">
                                    <input onchange="toggleBlock('tarif', 'data-tarif-descr')"
                                           class="form-check-input client-type-radio" type="checkbox" name="tariff"
                                           value="tariff"
                                           id="tarif">
