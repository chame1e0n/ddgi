                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="dogovor-num-strah" class="col-form-label">Номер договора
                                                страхования</label>
                                            <input disabled type="text" id="unique_number" name="unique_number" class="form-control @if($errors->has('unique_number')) is-invalid @endif" value="{{$page->unique_number}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="date_dogovor_strah" class="col-form-label">Дата договора
                                                страхования</label>
                                            <input disabled id="dogovor_zalog_date_to" name="insurance_from" type="date" value="{{$page->insurance_from}}"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label for="dogovor-num" class="col-form-label">Номер кредитного
                                                договора</label>
                                            <input disabled id="loan_reason" name="credit_dogovor_number" type="text"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input disabled id="credit_insurance_from" name="credit_insurance_from" type="date" value="{{$page->credit_insurance_from}}"
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input disabled id="credit_insurance_to" name="credit_insurance_to" type="date" value="{{$page->credit_insurance_to}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input disabled id="loan_reason" name="geo_zone" type="text"
                                ...
                                <div id="product-fields" data-info-table class="product-fields" data-field-number="0">
                                    <table class="table table-hover table-head-fixed" id="empTable1">
                                        ...
                                        @foreach($page->informations as $info)
                                            <tr id="a0">
                                                <td>
                                                    <input disabled type="text" class="form-control @if($errors->has('object_to_date')) is-invalid @endif" value="{{$info->policy_number}}" name="policy_number[]">
                                                </td>
                                                <td>
                                                    <input disabled type="text" class="form-control @if($errors->has('policy_series.0')) is-invalid @endif" value="{{$info->policy_series}}" name="policy_series[]">
                                                </td>
                                                <td>
                                                    <input disabled disabled="" type="date" class="form-control">
                                                </td>
                                                <td>
                                                    <input disabled type="text" class="form-control @if($errors->has('god_vipuska.0')) is-invalid @endif" value="{{$info->god_vipuska}}" name="god_vipuska[]">
                                                </td>
                                                <td>
                                                    <input disabled type="date" class="form-control @if($errors->has('policy_insurance_from.0')) is-invalid @endif" value="{{$info->policy_insurance_from}}" name="policy_insurance_from[]">
                                                </td>
                                                <td>
                                                    <input disabled type="date" class="form-control @if($errors->has('policy_insurance_to.0')) is-invalid @endif" value="{{$info->policy_insurance_to}}" name="policy_insurance_to[]">
                                                </td>
                                                <td>
                                                    <select disabled class="form-control @if($errors->has('otvet_litso.0')) is-invalid @endif"  id="polise_agents" name="otvet_litso[]" style="width: 100%;">
                                                ...
                                                <td>
                                                    <input disabled type="text" class="form-control @if($errors->has('marka.0')) is-invalid @endif" value="{{$info->marka}}" name="marka[]">
                                                </td>
                                                <td>
                                                    <input disabled type="text" class="form-control @if($errors->has('model.0')) is-invalid @endif" value="{{$info->model}}" name="model[]">
                                                </td>
                                                <td>
                                                    <input disabled type="text" class="form-control @if($errors->has('modification.0')) is-invalid @endif" value="{{$info->modification}}" name="modification[]">
                                                </td>


                                                <td>
                                                    <input disabled type="text" class="form-control @if($errors->has('gos_nomer.0')) is-invalid @endif" value="{{$info->gos_nomer}}" name="gos_nomer[]">
                                                </td>
                                                <td>
                                                    <input disabled type="text" class="form-control @if($errors->has('tex_passport.0')) is-invalid @endif" value="{{$info->tex_passport}}" name="tex_passport[]">
                                                </td>
                                                <td>
                                                    <input disabled type="text" class="form-control @if($errors->has('number_engine.0')) is-invalid @endif" value="{{$info->number_engine}}" name="number_engine[]">
                                                </td>
                                                <td>
                                                    <input disabled type="text" class="form-control @if($errors->has('number_kuzov.0')) is-invalid @endif" value="{{$info->number_kuzov}}" name="number_kuzov[]">
                                                </td>
                                                <td>
                                                    <input disabled type="text" class="form-control @if($errors->has('gryzopodemnost.0')) is-invalid @endif" value="{{$info->gryzopodemnost}}" name="gryzopodemnost[]">
                                                </td>
                                                <td>
                                                    <input disabled type="text" data-field="value" class="form-control @if($errors->has('strah_stoimost.0')) is-invalid @endif" value="{{$info->strah_stoimost}}" name="strah_stoimost[]">
                                                </td>
                                                <td>
                                                    <input disabled type="text" data-field="sum" class="form-control calc1 overall_insurance_sum-0 @if($errors->has('strah_sum.0')) is-invalid @endif" value="{{$info->strah_sum}}" name="strah_sum[]">
                                                </td>
                                                <td>
                                                    <input disabled type="text" data-field="premiya" class="form-control insurance_premium-0 @if($errors->has('strah_prem.0')) is-invalid @endif" value="{{$info->strah_prem}}" name="strah_prem[]">
                                                </td>
                                                <td>
                                                    <input disabled type="button" onclick="removeProductsFieldRow(0)" value="Удалить" class="btn btn-warning">
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input disabled readonly data-insurance-stoimost type="text" class="form-control overall-sum" /></td>
                                            <td><input disabled readonly data-insurance-sum type="text" class="form-control overall-sum4" /></td>
                                            <td><input disabled readonly data-insurance-award type="text" class="form-control overall-sum3" /></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-1">
                                                <div class="checkbox icheck-success">
                                                    <input disabled @if($page->defect_image && $page->defect_comment) checked @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group other_insurance_info-0">
                                                ...
                                                <input disabled class="form-control @if($errors->has('defect_comment')) is-invalid @endif" type="text" name="defect_comment"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-1">
                                                <div class="checkbox icheck-success">
                                                    <input disabled @if($page->strtahovka_comment || !empty(old('strtahovka_comment'))) checked @endif
                                    ...
                                    <div data-radiosuccess1="" class="form-group other_insurance_info"
                                        ...
                                        <input disabled id="strtahovka_info" class="form-control @if($errors->has('strtahovka_comment')) is-invalid @endif" type="text"
                        ...
                        <div id="payment-terms-form">
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" id="all-summ" name="insurance_sum_prod" class="form-control @if($errors->has('insurance_sum_prod')) is-invalid @endif"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" id="all-summ" name="insurance_bonus" class="form-control @if($errors->has('insurance_bonus')) is-invalid @endif"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" id="all-summ" name="franchise" class="form-control @if($errors->has('franchise')) is-invalid @endif"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-inline justify-content-between">
                                        ...
                                        <select disabled id="condition" class="form-control payment-schedule @if($errors->has('payment_term')) is-invalid @endif" name="payment_term"
                                                style="width: 100%; text-align: center">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group" data-tarif-descr
                                    ...
                                    <input disabled class="form-control @if($errors->has('tarif_other'))@endif" id="descrTarif" type="number" name="tarif_other"
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group" data-preim-descr
                                    ...
                                    <input disabled class="form-control  @if($errors->has('premiya_other'))@endif" id="descrPreim" type="number" name="premiya_other"
