            ...
            <section class="content">
                    ...
                    <div class="card-body">
                        <div id="client-product-form">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="icheck-success">
                                            <input readonly type="radio" name="client_type_radio" class="client-type-radio" id="client-type-radio-1" value="individual">
                                            <label for="client-type-radio-1">физ. лицо</label>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="icheck-success">
                                            <input readonly type="radio" name="client_type_radio" class="client-type-radio" id="client-type-radio-2" value="legal">
                            ...
                            <div class="form-group">
                                ...
                                <select readonly="" id="product-id" class="form-control select2" name="product_id" style="width: 100%;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly required type="text" id="insurer-name" name="fio_insurer"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="insurer-address" class="col-form-label">Юр адрес
                                            страхователя</label>
                                        <input readonly required value="{{$page->policyHolders->address}}" type="text" id="insurer-address"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly required value="{{$page->policyHolders->phone_number}}" type="text" id="insurer-tel"
                                               name="tel_insurer"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly required value="{{$page->policyHolders->checking_account}}" type="text" id="insurer-schet"
                                               name="address_schet"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly required value="{{$page->policyHolders->inn}}" type="text" id="insurer-inn"
                                               name="inn_insurer"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly required value="{{$page->policyHolders->mfo}}"  type="text" id="insurer-mfo" name="mfo_insurer"@if($errors->has('mfo_insurer'))
                                        class="form-control is-invalid"
                                               @else
                                               class="form-control"
                                            @endif >
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly required value="{{$page->policyHolders->oked}}" type="text" id="oked" name="oked"
                                               @if($errors->has('oked'))
                                               class="form-control is-invalid"
                                               @else
                                               class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly required value="{{$page->policyBeneficiaries->FIO}}" type="text"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="beneficiary-address" class="col-form-label">Адрес
                                                        выгодоприобретателя</label>
                                                    <input readonly required value="{{$page->policyBeneficiaries->address}}" type="text"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly required value="{{$page->policyBeneficiaries->phone_number}}" type="text"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly required value="{{$page->policyBeneficiaries->checking_account}}" type="text" id="beneficiary_schet"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly required value="{{$page->policyBeneficiaries->inn}}" type="number" id="inn_beneficiary"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly required value="{{$page->policyBeneficiaries->mfo}}" type="text" id="mfo_beneficiary"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly required value="{{$page->policyBeneficiaries->oked}}" type="text" id="oked_beneficiary"
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input readonly required type="text" id="dogovor-lizing-num" name="dogovor_lizing_num" class="form-control" value="{{$page->dogovor_lizing_num}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input readonly required id="insurance_from" name="insurance_from" type="date" class="form-control" value="{{$page->insurance_from}}">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <label class="col-form-label">Период</label>
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input readonly required id="insurance_to" name="insurance_to" type="date" class="form-control" value="{{$page->insurance_to}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card card-success">
                    ...
                    <div class="card-body">
                                ...
                                <table data-info-table="" class="table table-hover table-head-fixed" id="empTable">
                                    ...
                                    @if($page->infos->count() > 0)
                                        @foreach($page->infos as $info)
                                            <tr id="{{$info->id}}">
                                                <td>
                                                    <input readonly required type="text" class="form-control" name="name_property[]" value="{{$info->name_property}}">
                                                </td>
                                                <td>
                                                    <input readonly required type="text" class="form-control" name="place_property[]" value="{{$info->place_property}}">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input readonly required type="text" class="form-control" name="count_property[]" value="{{$info->count_property}}">
                                                </td>
                                                <td>
                                                    <select readonly="" required class="form-control polises" id="polises"
                                                ...
                                                <td>
                                                    <input readonly required type="text" data-field="value" class="form-control"
                                                           name="insurance_cost[]" value="{{$info->insurance_cost}}">
                                                </td>
                                                <td>
                                                    <input readonly required type="text" data-field="sum" class="form-control"
                                                           name="insurance_sum[]" value="{{$info->insurance_sum}}">
                                                </td>
                                                <td>
                                                    <input readonly required type="text" data-field="premiya" class="form-control"
                                                           name="insurance_premium[]" value="{{$info->insurance_premium}}">
                                                </td>
                                                <td class="form-group">
                                                    <input readonly required onclick="removeAndCalc({{$info->id}})" id="insurer-modal-button" type="button" class="btn btn-warning" value="Удалить">
                                                </td>
                                            </tr>
                                    ...
                                    @else
                                        <tr>
                                            <td>
                                                <input readonly required type="text" class="form-control" name="name_property[]">
                                            </td>
                                            <td>
                                                <input readonly required type="text" class="form-control" name="place_property[]">
                                            </td>
                                            <td>
                                                <input readonly required type="date" class="form-control"
                                            ...
                                            <td>
                                                <input readonly required type="text" class="form-control" name="count_property[]">
                                            </td>
                                            <td>
                                                <select readonly="" required class="form-control polises" id="polises"
                                                        name="units_property[]" style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td><input readonly required readonly data-insurance-stoimost type="text" class="form-control overall-sum" /></td>
                                        <td><input readonly required readonly data-insurance-sum type="text" class="form-control overall-sum4" /></td>
                                        <td><input readonly required readonly data-insurance-award type="text" class="form-control overall-sum3" /></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="icheck-success ">
                                <input readonly onchange="toggleBlock('tarif', 'data-tarif-descr')" class="form-check-input client-type-radio" type="checkbox" name="plans" id="tarif"
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly required type="text" id="geographic-zone" name="total_insurance_cost" class="form-control"  value="{{$page->total_insurance_cost}}">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label for="geographic-zone">Ответственное лицо</label>
                                        <select readonly="" @if($errors->has('zalog_otvet_litso'))
                                                class="form-control is-invalid"
                                                @else
                                                class="form-control"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly required type="date" class="form-control" name="date_of_issue_police" value="{{$page->date_of_issue_police}}">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <select readonly="" class="@if($errors->has('policy_series_id')) is-invalid @endif  form-control polises" id="policy_series_id"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly required type="text" id="place_of_insurance" name="place_of_insurance" class="form-control" value="{{$page->place_of_insurance}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <label for="currency_of_mutual">Валюта взаиморасчетов</label>
                                    <select readonly="" required class="form-control polises" id="walletNames" name="currency_of_mutual" style="width: 100%;">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input readonly required type="text" id="summ-1" name="insurance_amount_for_closed" class="form-control" value="{{$page->insurance_amount_for_closed}}">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="summ-2">Страховая сумма для открытого склада с общим площадью</label>
                                        <input readonly required type="text" id="summ-2" name="insurance_amount_for_open" class="form-control" value="{{$page->insurance_amount_for_open}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="geographic-zone">Страховая премия</label>
                                        <input readonly required type="text" id="geographic-zone" name="strahovaya_purpose_1" class="form-control" value="{{$page->strahovaya_purpose_1}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label for="polises">Условия оплаты страховой премии</label>
                                    <select readonly="" class="form-control polises" id="polises" name="poryadok_oplaty_premii_1" style="width: 100%;">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input readonly required type="text" id="summ-1" name="franshiza_1" class="form-control"  value="{{$page->franshiza_1}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input readonly required type="text" id="summ-2" name="franshiza_2" class="form-control" value="{{$page->franshiza_2}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input readonly required type="text" id="geographic-zone" name="franshiza_3" class="form-control" value="{{$page->franshiza_3}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly required id="strahovaya_sum" name="strahovaya_sum" value="{{$page->strahovaya_sum}}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="geographic-zone">Страховая премия</label>
                                        <input readonly required id="strahovaya_purpose" name="strahovaya_purpose" value="{{$page->strahovaya_purpose}}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input readonly required id="franshiza" name="franshiza" value="{{$page->franshiza}}"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-inline justify-content-between">
                                        ...
                                        <select readonly="" name="currencies" @if($errors->has('currencies'))
                                        class="form-control is-invalid"
                                                @else
                                                class="form-control"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-inline justify-content-between">
                                        ...
                                        <select readonly="" required id="condition" class="form-control
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-inline justify-content-between">
                                        ...
                                        <select readonly="" required class="form-control payment-schedule" name="sposob_rascheta" onchange="showDiv('other-payment-schedule', this)" style="width: 100%; text-align: center">
                                        ...
                                        @if($page->strahPremiya->count() > 0)
                                            @foreach($page->strahPremiya as $prem)
                                                <tr id="{{$prem->id}}" data-field-number="0">
                                                    <td><input readonly type="text" class="@if($errors->has('payment_sum.'.$loop->index))
                                                            is-invalid
@endif form-control" name="payment_sum[]" value="{{$prem->prem_sum}}">
                                                    </td>
                                                    <td><input readonly type="date" class="@if($errors->has('payment_from.'.$loop->index))
                                                            is-invalid
@endif form-control" name="payment_from[]" value="{{$prem->prem_from}}">
                                                    </td>
                                                    <td>
                                                        <input readonly type="button" value="Удалить" data-action="delete" class="btn btn-warning" onclick="removeEl({{$prem->id}})">
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @else
                                            <tr id="payment-term-tr-0" data-field-number="0">
                                                <td><input readonly type="text" class="@if($errors->has('payment_sum.*'))
                                                        is-invalid
                                                        @endif form-control" name="payment_sum[]" value="">
                                                </td>
                                                <td><input readonly type="date" class="@if($errors->has('payment_from.*'))
                                                        is-invalid
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select readonly="" class="@if($errors->has('serial_number_policy')) is-invalid @endif  form-control polises" id="serial_number_policy"
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input readonly required id="date_issue_policy" name="date_issue_policy" value="{{$page->date_issue_policy}}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @endif
                                                <input readonly  id="copy_passport" name="copy_passport" value="{{old('copy_passport')}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @endif
                                                <input readonly  id="copy_dogovor" name="copy_dogovor" value="{{old('copy_dogovor')}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @endif
                                                <input readonly  id="copy_spravki" name="copy_spravki" value="{{old('copy_spravki')}}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                @endif
                                                <input readonly id="copy_drugie" name="copy_drugie" value="{{old('copy_drugie')}}"
