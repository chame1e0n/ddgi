            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input required
                               class="form-control @if($errors->has('borrower.fio')) is-invalid @endif"
                               id="borrower-fio"
                               name="borrower[fio]"
                               type="text"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input required
                               class="form-control @if($errors->has('borrower.address')) is-invalid @endif"
                               id="borrower-address"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input required
                               class="form-control @if($errors->has('borrower.phone')) is-invalid @endif"
                               id="borrower-phone"
                               name="borrower[phone]"
                               type="text"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input required
                               class="form-control @if($errors->has('borrower.bank_account')) is-invalid @endif"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input required
                               class="form-control @if($errors->has('borrower.inn')) is-invalid @endif"
                               id="borrower-inn"
                               name="borrower[inn]"
                               type="text"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input required
                               class="form-control @if($errors->has('borrower.mfo')) is-invalid @endif"
                               id="borrower-mfo"
                               name="borrower[mfo]"
                               type="text"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select required
                                class="form-control @if($errors->has('borrower.bank_id')) is-invalid @endif"
                                id="borrower-bank-id"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control @if($errors->has('borrower.oked')) is-invalid @endif"
                               id="borrower-oked"
                               name="borrower[oked]"
                               type="text"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input required
                               class="form-control @if($errors->has('borrower.passport_series')) is-invalid @endif"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input required
                               class="form-control @if($errors->has('borrower.passport_number')) is-invalid @endif"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input class="form-control polises @if($errors->has('borrower.passport_issued_place')) is-invalid @endif"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input class="form-control polises @if($errors->has('borrower.passport_issued_date')) is-invalid @endif"
