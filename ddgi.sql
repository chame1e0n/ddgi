...
--
-- Database: ddgi
-- Generation Time: 2021-05-10 01:57:34.9030
-- -------------------------------------------------------------
...
DROP TABLE IF EXISTS `accompanying_people`;
CREATE TABLE `accompanying_people` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `cargo_infos_id` bigint unsigned NOT NULL,
  `fio_accompanying` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `position_accompanying` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `all_product_information`;
CREATE TABLE `all_product_information` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `all_products_id` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `policy_id` bigint DEFAULT NULL,
  `data_vidachi` date DEFAULT NULL,
  `period_deystviya_ot` date DEFAULT NULL,
  `period_deystviya_do` date DEFAULT NULL,
  `otvet_litso` bigint DEFAULT NULL,
  `kolichestvo` bigint DEFAULT NULL,
  `strah_stoimost` bigint DEFAULT NULL,
  `strah_summa` bigint DEFAULT NULL,
  `strah_premiya` bigint DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `all_products` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `policy_holder_id` bigint DEFAULT NULL,
  `policy_beneficiaries_id` bigint DEFAULT NULL,
  `zaemshik_id` bigint DEFAULT NULL,
  `type` tinyint DEFAULT NULL,
  `unique_number` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `fio_insured` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `address_insured` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `client_type_radio` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `product_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `steamer_point` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `appointment_point` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `ts_osnovanii` bigint DEFAULT NULL,
  `geo_zone` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `overloads_place` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `country_of_insurance` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `location_of_cargo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `location` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `property_name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `fire_alarm_file` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `security_file` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `franshize_percent_1` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `franshize_percent_2` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `franshize_percent_3` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `name_of_cargo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_of_cargo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_packaging` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `weight_of_cargo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `amount_of_cargo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `type_of_transport` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `qualities_of_cargo` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `fio_accompanying` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `position_accompanying` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `amount_of_cargo_place` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `transporter` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `name_of_shipper` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `address_shipper` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `name_consignee` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `address_consignee` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `loan_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `loan_reason` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `condition_insurance` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `accompanying_file` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_giving_insurance` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `responsible_person` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `application_form` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `contract` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `policy` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `tel_insured` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `passport_series_insured` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `passport_num_insured` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `credit_contract` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `credit_contract_to` date DEFAULT NULL,
  `insurance_from` date DEFAULT NULL,
  `insurance_to` date DEFAULT NULL,
  `sum_of_insurance` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `bonus` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `tariff` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `percent_of_tariff` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `ocenka_osnovaniya` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `nomer_dogovor_strah_vigod` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_dogovor_strah_vigod` date DEFAULT NULL,
  `insurance_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_bonus` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `franchise` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_premium_currency` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `payment_term` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `sposob_rascheta` int DEFAULT NULL,
  `tarif_other` double(8,2) DEFAULT NULL,
  `premiya_other` double(8,2) DEFAULT NULL,
  `payment_sum_main` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `payment_from_main` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `way_of_calculation` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `application_form_file` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `contract_file` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `policy_file` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `user_id` bigint DEFAULT NULL,
  `comments` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `dogovor_lizing_num` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_aim` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `currency` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `credit_dogovor_number` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `credit_dogovor_from_date` date DEFAULT NULL,
  `object_from_date` date DEFAULT NULL,
  `object_to_date` date DEFAULT NULL,
  `vid_zalog_obespech` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `product_desc` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `sum_zalog_obespech` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `other_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_total_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_gift` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `payment_currency` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_series` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_from` date DEFAULT NULL,
  `litso` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `passport_copy` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `dogovor_copy` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `spravka_copy` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `spravka_rabota_copy` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `other_copy` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `other` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `file` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `policy_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `policy_series_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `state` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `period_insurance_from` date DEFAULT NULL,
  `period_insurance_to` date DEFAULT NULL,
...
DROP TABLE IF EXISTS `all_products_terms_transhes`;
CREATE TABLE `all_products_terms_transhes` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `all_products_id` bigint unsigned DEFAULT NULL,
  `payment_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_from` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `audit_infos` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `otvetsvennost_audit_id` bigint unsigned NOT NULL,
  `number_polis` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `series_polis` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `validity_period_from` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `validity_period_to` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_agent` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_mark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `specialty` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `workExp` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_model` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `arriving_time` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cost_of_insurance` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sum_of_insurance` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bonus_of_insurance` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `audit_turnovers`;
CREATE TABLE `audit_turnovers` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `polis_premium` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `turnover` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `net_profit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `second_polis_premium` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `second_turnover` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `second_net_profit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `bonded`;
CREATE TABLE `bonded` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_id` int unsigned NOT NULL,
  `policy_beneficiary_id` int unsigned NOT NULL DEFAULT '0',
  `policy_id` int unsigned NOT NULL DEFAULT '0',
  `policy_series_id` int unsigned NOT NULL DEFAULT '0',
  `user_id` int unsigned NOT NULL DEFAULT '0',
  `policy_from_date` date DEFAULT NULL,
  `policy_holder_id` int unsigned NOT NULL DEFAULT '0',
  `insurance_premium_payment_type` int unsigned NOT NULL,
  `from_date` date DEFAULT NULL,
  `to_date` date DEFAULT NULL,
  `volume` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_premium_currency_rate` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_premium_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `unique_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `volume_measure` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `total_insured_price` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Общая страховая сумма',
  `total_insured_closed_stock_price` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Страховая сумма для закрытого склада с общим объемом',
  `total_insured_open_stock_price` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Страховая сумма для открытого склада с общим площадью',
  `insurance_premium` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `settlement_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Валюта взаиморасчетов',
  `premium_terms` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `bonded_policy_informations`;
CREATE TABLE `bonded_policy_informations` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `bonded_id` int unsigned NOT NULL,
  `policy_series_id` int unsigned NOT NULL,
...
DROP TABLE IF EXISTS `borrower_sportsman_infos`;
CREATE TABLE `borrower_sportsman_infos` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `borrower_sportsman_id` bigint unsigned NOT NULL,
  `policy_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_series` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_chronic` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_agent` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_fio` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_date_birth` date DEFAULT NULL,
  `polis_passport_series` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_usable_period` date DEFAULT NULL,
  `polis_benefit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_overall_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `borrower_sportsman_others`;
CREATE TABLE `borrower_sportsman_others` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `borrower_sportsman_id` bigint unsigned NOT NULL,
  `other_mark_model` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_name_tools` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_series_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_insurance_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_total` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_cover_terror_attacks_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_cover_terror_attacks_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cover_terror_attacks_insured_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_cover_terror_attacks_insured_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_coverage_evacuation_cost` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_coverage_evacuation_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_insurance_info` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `one_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `one_premia` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `one_franshiza` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tho_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `two_preim` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `driver_quantity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `driver_one_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `driver_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `driver_total_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `driver_preim_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `passenger_quantity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `passenger_one_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `passenger_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `passenger_total_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `passenger_preim_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `limit_quantity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `limit_one_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `limit_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `limit_total_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `limit_preim_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_liability_limit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_liability_limit_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_form_policy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_from_date` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_agent` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_payment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_order` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `other_totally_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `borrower_sportsmen`;
CREATE TABLE `borrower_sportsmen` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `policy_holder_id` bigint unsigned NOT NULL,
  `insurance_from` date DEFAULT NULL,
  `insurance_to` date DEFAULT NULL,
  `polis_series` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_giving_date` date DEFAULT NULL,
  `litso` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_premium_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_term` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `all_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_bonus` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `branches` (
  ...
  `name` varchar(150) NOT NULL,
  `is_center` tinyint unsigned DEFAULT '0',
...
DROP TABLE IF EXISTS `cargo_infos`;
CREATE TABLE `cargo_infos` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `policy_holder_id` bigint unsigned NOT NULL,
  `policy_beneficiary_id` bigint unsigned NOT NULL,
  `client_type_radio` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dogovor_lizing_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_from` date DEFAULT NULL,
  `steamer_point` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `appointment_point` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `geo_zone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `overloads_place` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country_of_insurance` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `location_of_cargo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_of_cargo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_of_cargo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_packaging` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `weight_of_cargo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount_of_cargo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type_of_transport` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `qualities_of_cargo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fio_accompanying` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `position_accompanying` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount_of_cargo_place` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transporter` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_of_shipper` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_shipper` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name_consignee` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_consignee` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_period_from` date DEFAULT NULL,
  `insurance_to` date DEFAULT NULL,
  `packaging_period_from` date DEFAULT NULL,
  `packaging_period_to` date DEFAULT NULL,
  `condition_insurance` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `accompanying_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_bonus` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `franchise` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_premium_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_term` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_sum_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_from_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_series` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_giving_insurance` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `responsible_person` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `application_form` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `cargo_payment_terms`;
...
CREATE TABLE `clients` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `type` tinyint unsigned NOT NULL DEFAULT '0' COMMENT '0 - физ лицо, 1 - юр лицо',
...
CREATE TABLE `cmp` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `type` tinyint unsigned NOT NULL DEFAULT '0' COMMENT 'тип юр.= 1; физ = 0',
  `product_id` int unsigned DEFAULT NULL,
  `policy_id` int unsigned DEFAULT NULL,
  `policy_series_id` int unsigned DEFAULT NULL,
  `policy_holder_id` int unsigned NOT NULL,
  ...
  `insurance_premium_payment_type` int unsigned DEFAULT NULL,
...
DROP TABLE IF EXISTS `covid_policy_information`;
CREATE TABLE `covid_policy_information` (
  ...
  `person_surname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `person_lastname` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `series_and_number_passport` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `place_of_issue_passport` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_of_issue_passport` date NOT NULL,
  `policy_series_id` int NOT NULL,
...
DROP TABLE IF EXISTS `covid_strah_premiyas`;
CREATE TABLE `covid_strah_premiyas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `prem_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `covids` (
  ...
  `strahovaya_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `strahovaya_purpose` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `franshiza` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `currencies` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `poryadok_oplaty_premii` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sposob_rascheta` int NOT NULL,
  `serial_number_policy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_issue_policy` date NOT NULL,
  `otvet_litso` int NOT NULL,
  `anketa_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dogovor_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_holder_id` int NOT NULL,
  `policy_beneficiary_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `credit_fin_risk_nepogashen_avtocredits`;
CREATE TABLE `credit_fin_risk_nepogashen_avtocredits` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `dogovor_lizing_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Кредитный договор',
  `insurance_from` date NOT NULL COMMENT 'Срок кредитования С',
  `insurance_to` date NOT NULL COMMENT 'Срок кредитования До',
  `credit_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `credit_purpose` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Цель получения кредита',
  `franchise` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_issue_policy` date DEFAULT NULL COMMENT 'Срок действия договора',
  `total_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_award` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_terms` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Условия оплаты',
  `serial_number_policy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `data_delivery_policy` date NOT NULL COMMENT 'Дата выдачи страхового полиса',
  `policy_holder_id` int NOT NULL,
  `agent_id` int NOT NULL,
  `zaemshik_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `credit_fin_risk_nepogashen_credits`;
CREATE TABLE `credit_fin_risk_nepogashen_credits` (
  ...
  `credit_purpose` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci COMMENT 'Цель получения кредита',
  `date_issue_policy` date DEFAULT NULL COMMENT 'Срок действия договора',
  `other_forms` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_award` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_terms` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Условия оплаты',
  `serial_number_policy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `credit_nepogashens`;
CREATE TABLE `credit_nepogashens` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `dogovor_credit_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `credit_from` date NOT NULL,
  `credit_to` date NOT NULL,
  `credit_validity_period` date NOT NULL,
  `credit_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `credit_purpose` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `other_forms` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `total_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_award` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `currency_terms`;
...
DROP TABLE IF EXISTS `currency_terms_transhes`;
CREATE TABLE `currency_terms_transhes` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `borrower_id` bigint unsigned NOT NULL,
  `payment_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_from` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `dobrovolka_avto`;
CREATE TABLE `dobrovolka_avto` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `period_insurance_from` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `period_insurance_to` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ispolzovaniya_TS_na_osnovanii` int DEFAULT NULL,
  `geograficheskaya_zona` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `defects` int DEFAULT NULL,
  `defects_images` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cel_ispolzovaniya` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `valyuta` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `poryadok_oplaty_premii` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sposob_rascheta` int DEFAULT NULL,
  `strahovaya_summa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `strahovaya_premiya` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `franshiza` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `anketa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dogovor` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `dobrovolka_avto_info`;
CREATE TABLE `dobrovolka_avto_info` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `seriya_polisa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `period_dejstviya_polisa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `vybor_agenta` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `id_stroku` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `marka` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `model` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `modificacia` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gos_nomer` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nomer_tex_passport` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nomer_dvigatelya` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gryzopodemnost` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `colichestvo_posadochnix_mest` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `strahovaya_stoimost` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `straxovay_premiya` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `gibel_avto` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `neschastnuy_slushau` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `avto_otvetstvennost` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `zastrahovanu_avto` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `dobrovolka_avto_poryadok_oplaty`;
CREATE TABLE `dobrovolka_avto_poryadok_oplaty` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `dobrovolka_avto_id` int NOT NULL,
  `poryadok_oplaty_summa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `poryadok_oplaty_from` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `dobrovolka_teztools`;
...
DROP TABLE IF EXISTS `from_site_orders`;
...
DROP TABLE IF EXISTS `kasco_strah_premiya`;
CREATE TABLE `kasco_strah_premiya` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `kasco_id` int NOT NULL,
  `strah_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `kasko` (
  ...
  `geo_zone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `strahovaya_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `strahovaya_purpose` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `franshiza` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `insurance_premium_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_term` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sposob_rascheta` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_series` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `insurance_from_date` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `policy_holder_id` int NOT NULL,
  `policy_beneficiary_id` int NOT NULL,
  `otvet_litso` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `anketa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `dogovor` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `kasko_policy_beneficiaries` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `policy_beneficiary_id` int unsigned NOT NULL,
  `kasko_id` int unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `kasko_policy_holders` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `policy_holders_id` int unsigned NOT NULL,
  `kasko_id` int unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `kasko_policy_informations` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `polis_god_vupyska` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_date_from` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_date_to` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_marka` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_model` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_gos_nomer` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_nomer_tex_passporta` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_nomer_dvigatelya` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_nomer_kuzova` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_gruzopodoemnost` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_strah_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_strah_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_strah_premia` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `mark_model` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `series_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `insurance_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cover_terror_attacks_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cover_terror_attacks_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cover_terror_attacks_insured_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `cover_terror_attacks_insured_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `coverage_evacuation_cost` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `coverage_evacuation_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `other_insurance_info` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `one_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `one_premia` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `one_franshiza` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `limit_total_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `limit_preim_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_liability_limit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `total_liability_limit_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `from_date` date NOT NULL,
  `policy_id` int NOT NULL,
  `agent_id` int NOT NULL,
  `payment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_order` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `overall_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_series_id` int NOT NULL,
  `policy_agent_id` int NOT NULL,
  `kasko_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `lising_product`;
CREATE TABLE `lising_product` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `client_type_radio` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `fio_insurer` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `address_insurer` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `tel_insurer` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `address_schet` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `inn_insurer` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `mfo_insurer` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `bank_insurer` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `okonh_insurer` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `fio_beneficiary` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `address_beneficiary` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `tel_beneficiary` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `beneficiary_schet` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `inn_beneficiary` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `mfo_beneficiary` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `bank_beneficiary` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `okonh_beneficiary` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `dogovor_lizing_num` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_from` date DEFAULT NULL,
  `insurance_to` date DEFAULT NULL,
  `geo_zone` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_series_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_mark_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_model_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_modification_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_gos_num_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_teh_passport_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_num_engine_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_num_body_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_payload_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_places_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `overall_polis_sum_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_premium_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `mark_model` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `name` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `series_number` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `total` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cover_terror_attacks_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cover_terror_attacks_currency` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cover_terror_attacks_insured_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `cover_terror_attacks_insured_currency` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `coverage_evacuation_cost` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `coverage_evacuation_currency` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `strtahovka_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `other_insurance_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `vehicle_damage` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `one_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `one_premia` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `one_franshiza` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `civil_liability` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `tho_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `two_preim` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `accidents` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `driver_quantity` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `driver_one_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `driver_currency` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `driver_total_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `driver_preim_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `passenger_quantity` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `passenger_one_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `passenger_currency` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `passenger_total_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `passenger_preim_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `limit_quantity` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `limit_one_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `limit_currency` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `limit_total_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `limit_preim_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `total_liability_limit_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `total_liability_limit_currency_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `policy` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `from_date` date DEFAULT NULL,
  `agent` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `payment` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `payment_order` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_premium_currency` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `payment_term` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `payment_sum_0_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `payment_from_0_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_series` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `litso` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `mejd_currency_terms_transhes`;
...
DROP TABLE IF EXISTS `neshchastka24_times`;
CREATE TABLE `neshchastka24_times` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `insurance_from` date NOT NULL,
  `insurance_to` date NOT NULL,
  `strah_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `strah_prem` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `franshiza` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `insurance_premium_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_term` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `sposob_rascheta` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS `neshchastka24_times_strah_premiya`;
CREATE TABLE `neshchastka24_times_strah_premiya` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `neshchastka24_time_id` int NOT NULL,
  `payment_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS `neshchastka24time_information`;
CREATE TABLE `neshchastka24time_information` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `neshchastka24_time_id` int NOT NULL,
  `polis_id` int NOT NULL,
  `agents` int NOT NULL,
  `period_polis` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_agent` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_model` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_modification` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_teh_passport` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_num_engine` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_num_body` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_payload` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `neshchastka_borrowers`;
CREATE TABLE `neshchastka_borrowers` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `policy_holder_id` bigint unsigned NOT NULL,
  `policy_beneficiaries_id` bigint unsigned NOT NULL,
  `fio_insured` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `address_insured` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tel_insured` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `passport_series_insured` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `passport_num_insured` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `credit_contract` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `credit_contract_to` date DEFAULT NULL,
  `insurance_from` date DEFAULT NULL,
  `insurance_to` date DEFAULT NULL,
  `tariff` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `percent_of_tariff` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_bonus` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `franchise` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_premium_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_term` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `way_of_calculation` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_sum_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_from_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_series` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_insurance_from` date DEFAULT NULL,
  `person` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `application_form_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contract_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `notary_payment_term`;
CREATE TABLE `notary_payment_term` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `payment_sum` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `payment_from` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `notary_id` bigint unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `otvetstvennost_brokers`;
CREATE TABLE `otvetstvennost_brokers` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `informaciya_o_personale` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `from_date` date NOT NULL,
  `to_date` date NOT NULL,
  `geo_zone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_term` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `currencies` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `strahovaya_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `strahovaya_purpose` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `serial_number_policy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `date_issue_policy` date DEFAULT NULL,
  `otvet_litso` int NOT NULL,
  `policy_holder_id` int NOT NULL,
...
DROP TABLE IF EXISTS `otvetstvennost_natarius`;
CREATE TABLE `otvetstvennost_natarius` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `info_personal` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_from` date DEFAULT NULL,
  `insurance_to` date DEFAULT NULL,
  `geo_zone` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `public_sector_comment` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `private_sector_comment` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `riski` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `other_insurance_0` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `reason_case` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `administrative_case` tinyint(1) DEFAULT NULL,
  `reason_administrative_case` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `sphereOfActivity` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `profInsuranceServices` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `retransferAktFile` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `wallet` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `sum_insured` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `franchise` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_premium` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_series` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_policy_from` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `anketaFile` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `dogovorFile` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polisFile` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `litso` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `payment_term` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `otvetstvennost_natarius_grey`;
CREATE TABLE `otvetstvennost_natarius_grey` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `number` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `director` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `qualified` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `other` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `otvetstvennost_natarius_info`;
CREATE TABLE `otvetstvennost_natarius_info` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `period_polis` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `validity_period_from` date DEFAULT NULL,
  `validity_period_to` date DEFAULT NULL,
  `polis_agent` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_mark` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `specialty` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `workExp` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_model` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_modification` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_gos_num` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `polis_teh_passport` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `otvetstvennost_otsenshiki`;
CREATE TABLE `otvetstvennost_otsenshiki` (
  ...
  `insurance_to` date NOT NULL,
  `geo_zone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `first_year` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `second_year` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `first_turnover` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `second_turnover` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_turnover` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `first_profit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `second_profit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_profit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sfera_deyatelnosti` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `limit_otvetstvennosti` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `documents` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_premium_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `poryadok_oplaty_premii` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `strahovaya_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `strahovaya_purpose` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `franshiza` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `serial_number_policy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `date_issue_policy` date NOT NULL,
  `otvet_litso` int NOT NULL,
  ...
  `dogovor` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `public_sector_comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `private_sector_comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reason_case` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reason_administrative_case` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_holder_id` int NOT NULL,
  `prof_riski` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `otvetstvennost_otsenshiki_info`;
CREATE TABLE `otvetstvennost_otsenshiki_info` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `insurer_price` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `insurer_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `insurer_premium` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `time_stay` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `insurer_fio` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `from_date_polis` date NOT NULL,
  `to_date_polis` date NOT NULL,
  `otvetstvennost_otsenshiki_id` int NOT NULL,
  `agent_id` int NOT NULL,
  `policy_series_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `otvetstvennost_otsenshiki_strah_premiyas`;
...
DROP TABLE IF EXISTS `otvetstvennost_podryadchik_strah_premiyas`;
CREATE TABLE `otvetstvennost_podryadchik_strah_premiyas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `prem_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `prem_from` date NOT NULL,
  `otvetstvennost_podryadchik_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `otvetstvennost_podryadchiks`;
CREATE TABLE `otvetstvennost_podryadchiks` (
  ...
  `currencies` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `strahovaya_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `serial_number_policy` int unsigned DEFAULT NULL,
  `strahovaya_purpose` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `policy_id` int unsigned DEFAULT NULL,
  `product_id` int unsigned DEFAULT NULL,
  `insurance_premium_payment_type` int unsigned DEFAULT NULL,
...
DROP TABLE IF EXISTS `otvetstvennost_realtor_infos`;
CREATE TABLE `otvetstvennost_realtor_infos` (
  ...
  `from_date_polis` date NOT NULL,
  `to_date_polis` date NOT NULL,
  `otvetstvennost_realtor_id` int NOT NULL,
  `agent_id` int NOT NULL,
  `policy_series_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `otvetstvennost_realtor_strah_premiyas`;
...
DROP TABLE IF EXISTS `otvetstvennost_realtors`;
CREATE TABLE `otvetstvennost_realtors` (
  ...
  `second_profit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_profit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sfera_deyatelnosti` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `limit_otvetstvennosti` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `documents` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `insurance_premium_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `poryadok_oplaty_premii` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `activity_period_from` date DEFAULT NULL,
  `activity_period_to` date DEFAULT NULL,
  `activity_period_all` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `reason_administrative_case` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `prof_riski` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `anketa` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dogovor` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_holder_id` int NOT NULL,
...
DROP TABLE IF EXISTS `otvetsvennost_audits`;
CREATE TABLE `otvetsvennost_audits` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `policy_holder_id` bigint unsigned NOT NULL,
  `audit_turnover_id` bigint unsigned NOT NULL,
  `insurance_from` date DEFAULT NULL,
  `insurance_to` date DEFAULT NULL,
  `geo_zone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `active_period_from` date DEFAULT NULL,
  `active_period_to` date DEFAULT NULL,
  `questionnaire` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contract` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_series` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_from` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `litso` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `insurance_premium_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_term` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `all_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `payment_sum_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_from_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `acted` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `public_sector_comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `private_sector_comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `risk` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cases` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reason_case` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `administrative_case` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `reason_administrative_case` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sphere_of_activity` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prof_insurance_services` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `liability_limit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `retransfer_akt_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `number_polis_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `series_polis_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `validity_period_from_main` date DEFAULT NULL,
  `validity_period_to_main` date DEFAULT NULL,
  `polis_agent_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_mark_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `specialty_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `workExp_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `polis_model_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `arriving_time_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cost_of_insurance_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sum_of_insurance_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bonus_of_insurance_main` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
DROP TABLE IF EXISTS `perestrahovaniya_overviews`;
CREATE TABLE `perestrahovaniya_overviews` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `user_id` bigint unsigned NOT NULL,
  `perestrahivaniya_id` bigint unsigned NOT NULL,
...
DROP TABLE IF EXISTS `perestrahovaniyas`;
CREATE TABLE `perestrahovaniyas` (
  ...
  `policy_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_series_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `policies` (
  ...
  `policy_series_id` int DEFAULT '0',
...
DROP TABLE IF EXISTS `policies_policy_retransfer`;
CREATE TABLE `policies_policy_retransfer` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `policy_retransfer_id` int unsigned NOT NULL,
  `policy_id` int unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `policies_policy_transfer` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `policy_transfer_id` int unsigned NOT NULL,
  `policy_id` int unsigned NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `policy_beneficiaries` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='выгодоприобретатель';

DROP TABLE IF EXISTS `policy_flow_files`;
CREATE TABLE `policy_flow_files` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `policy_flow_id` int unsigned NOT NULL DEFAULT '0',
  `name` varchar(150) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
...
DROP TABLE IF EXISTS `policy_flows`;
CREATE TABLE `policy_flows` (
  ...
  `policy_from` int DEFAULT NULL,
  `policy_to` int DEFAULT NULL,
  `polis_name` varchar(100) DEFAULT NULL,
  `price_per_policy` varchar(100) DEFAULT NULL,
  `polis_given_by_user_id` int unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `policy_holders` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=111 DEFAULT CHARSET=utf8 COMMENT='страхователи';
...
DROP TABLE IF EXISTS `policy_retransfer`;
CREATE TABLE `policy_retransfer` (
  ...
  `policy_series_id` int DEFAULT NULL,
...
DROP TABLE IF EXISTS `pretensii`;
CREATE TABLE `pretensii` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `pretensii_status_id` int unsigned DEFAULT NULL,
...
DROP TABLE IF EXISTS `pretensii_overview`;
CREATE TABLE `pretensii_overview` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `pretensii_id` int unsigned NOT NULL DEFAULT '0',
  `user_id` int unsigned NOT NULL DEFAULT '0',
  `passed` tinyint unsigned NOT NULL COMMENT '1 - прошел ; 0 - не прошел',
...
DROP TABLE IF EXISTS `pretensii_status`;
...
DROP TABLE IF EXISTS `product3777s`;
CREATE TABLE `product3777s` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `policy_holder_id` bigint unsigned NOT NULL,
  `zaemshik_id` bigint unsigned NOT NULL,
  `dogovor_lizing_num` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `insurance_from` date NOT NULL,
  `insurance_to` date NOT NULL,
  `insurance_aim` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `insurance_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `franshiza` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `object_from_date` date NOT NULL,
  `object_to_date` date NOT NULL,
  `other_info` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `insurance_total_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `insurance_gift` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_currency` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment_term` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_series` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `polis_from` date NOT NULL,
  `litso` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `passport_copy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `dogovor_copy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `spravka_copy` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
DROP TABLE IF EXISTS `property_lising_zalog`;
...
DROP TABLE IF EXISTS `request_overviews`;
...
CREATE TABLE `requests` (
  ...
  `is_underwritting_request` tinyint unsigned NOT NULL DEFAULT '0',
  `is_perestrahovaniya_request` tinyint unsigned NOT NULL DEFAULT '0',
  `comments` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `act_number` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `limit_reason` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `policy_id` int unsigned DEFAULT NULL,
  `policy_series_id` int unsigned DEFAULT NULL,
  `polis_quantity` int unsigned DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
DROP TABLE IF EXISTS `tamozhnya_add_legal_strah_premiyas`;
CREATE TABLE `tamozhnya_add_legal_strah_premiyas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `prem_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `prem_from` date NOT NULL,
  `tamozhnya_add_legal_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `tamozhnya_add_legals`;
CREATE TABLE `tamozhnya_add_legals` (
  ...
  `prichina_pretenzii` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `strahovaya_purpose` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `franshiza` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `serial_number_policy` int DEFAULT NULL,
  `date_issue_policy` date DEFAULT NULL,
  `otvet_litso` int NOT NULL,
  `policy_holder_id` int NOT NULL,
  `anketa_img` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `tamozhnya_add_strah_premiyas`;
CREATE TABLE `tamozhnya_add_strah_premiyas` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `prem_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `prem_from` date NOT NULL,
  `tamozhnya_add_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `tamozhnya_adds`;
CREATE TABLE `tamozhnya_adds` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `from_date` date NOT NULL,
  `to_date` date NOT NULL,
  `warehouse_volume` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_volume` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_volume_unit` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `total_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
DROP TABLE IF EXISTS `zaemshiks`;
CREATE TABLE `zaemshiks` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `z_fio` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `z_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `z_phone` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `passport_series` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `passport_number` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `passport_issued` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `passport_when_issued` date NOT NULL,
  `z_checking_account` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `z_inn` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `z_mfo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `bank_id` int NOT NULL,
  `z_okonx` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `z_oked` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `zalog_imushestvo_infos`;
CREATE TABLE `zalog_imushestvo_infos` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `name_property` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Наименование Имущества',
  `place_property` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Местонахождения имущества',
  `date_of_issue_property` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Дата выдачи',
  `count_property` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Кол-во шт.',
  `units_property` int NOT NULL COMMENT 'Единицы измерения',
  `insurance_cost` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Страховая стоимость',
  `insurance_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Страховая сумма',
  `insurance_premium` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Страховая премия',
  `zalog_imushestvo_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `zalog_imushestvo_strah_premiyas`;
...
DROP TABLE IF EXISTS `zalog_imushestvos`;
CREATE TABLE `zalog_imushestvos` (
  ...
  `plans_percent` int DEFAULT NULL,
  `total_insurance_cost` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Общая страховая стоимость',
  `zalog_otvet_litso` int NOT NULL COMMENT 'Ответственное лицо',
  `date_of_issue_police` date NOT NULL COMMENT 'Дата выдачи страхового полиса (клиенту)',
  `policy_series_id` int NOT NULL COMMENT 'Серийный номер полиса страхования (Верх)',
  `place_of_insurance` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Место страхования',
  `currency_of_mutual` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Валюта взаиморасчетов',
  `insurance_amount_for_closed` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Страховая сумма для закрытого склада с общим объемом',
  `insurance_amount_for_open` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Страховая сумма для открытого склада с общим объемом',
  `strahovaya_purpose_1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Страховая премия (Верх)',
  `poryadok_oplaty_premii_1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Условия оплаты страховой премии (Верх)',
  `franshiza_1` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '% от страховой суммы по риску землетрясения и пожара по каждому убытку и/или по всем убыткам в результате каждого страхового случая',
  `franshiza_2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '% от страховой суммы по риску противоправные действия третьих лиц по каждому убытку и/или по всем убыткам в результате каждого страхового случая',
  `franshiza_3` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '% от страховой суммы по другим рискам по каждому убытку и/или по всем убыткам в результате каждого страхового случая',
  `strahovaya_sum` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `strahovaya_purpose` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `franshiza` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `currencies` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `policy_holder_id` int NOT NULL,
  `policy_beneficiary_id` int NOT NULL,
  `copy_passport` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `copy_dogovor` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `copy_spravki` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `copy_drugie` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

DROP TABLE IF EXISTS `zalogodatels`;
CREATE TABLE `zalogodatels` (
  ...
  `checking_account` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `inn` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `mfo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `bank_id` int NOT NULL,
  `oked` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `all_product_information` (`id`, `all_products_id`, `created_at`, `updated_at`, `deleted_at`, `policy_id`, `data_vidachi`, `period_deystviya_ot`, `period_deystviya_do`, `otvet_litso`, `kolichestvo`, `strah_stoimost`, `strah_summa`, `strah_premiya`) VALUES
(1, 1, '2021-04-19 08:12:27', '2021-04-19 08:12:27', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 2, '2021-04-19 08:13:24', '2021-04-19 08:13:24', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 7, '2021-05-08 20:14:00', '2021-05-09 16:27:32', NULL, 1, '2021-05-08', '2021-05-09', '2021-05-10', 1, 2, 2, 2, 2),
(7, 7, '2021-05-09 16:28:43', '2021-05-09 16:28:43', NULL, 561, '2021-05-26', '2021-05-21', '2021-05-23', 1, 5, 5, 5, 5),
(8, 9, '2021-05-09 20:55:40', '2021-05-09 20:55:40', NULL, 563, '2021-05-22', NULL, NULL, 2, NULL, NULL, NULL, NULL);

INSERT INTO `all_products` (`id`, `policy_holder_id`, `policy_beneficiaries_id`, `zaemshik_id`, `type`, `unique_number`, `fio_insured`, `address_insured`, `client_type_radio`, `product_id`, `steamer_point`, `appointment_point`, `ts_osnovanii`, `geo_zone`, `overloads_place`, `country_of_insurance`, `location_of_cargo`, `location`, `property_name`, `fire_alarm_file`, `security_file`, `franshize_percent_1`, `franshize_percent_2`, `franshize_percent_3`, `name_of_cargo`, `type_of_cargo`, `type_packaging`, `weight_of_cargo`, `amount_of_cargo`, `type_of_transport`, `qualities_of_cargo`, `fio_accompanying`, `position_accompanying`, `amount_of_cargo_place`, `transporter`, `name_of_shipper`, `address_shipper`, `name_consignee`, `address_consignee`, `insurance_period_from`, `packaging_period_from`, `packaging_period_to`, `term_from`, `term_to`, `waiting_period_from`, `waiting_period_to`, `loan_sum`, `loan_reason`, `condition_insurance`, `accompanying_file`, `date_giving_insurance`, `responsible_person`, `application_form`, `contract`, `policy`, `tel_insured`, `passport_series_insured`, `passport_num_insured`, `credit_contract`, `credit_contract_to`, `insurance_from`, `insurance_to`, `sum_of_insurance`, `bonus`, `tariff`, `percent_of_tariff`, `ocenka_osnovaniya`, `nomer_dogovor_strah_vigod`, `date_dogovor_strah_vigod`, `insurance_sum`, `insurance_bonus`, `franchise`, `insurance_premium_currency`, `payment_term`, `sposob_rascheta`, `tarif_other`, `premiya_other`, `payment_sum_main`, `payment_from_main`, `way_of_calculation`, `application_form_file`, `contract_file`, `policy_file`, `user_id`, `comments`, `dogovor_lizing_num`, `insurance_aim`, `currency`, `credit_dogovor_number`, `credit_dogovor_from_date`, `object_from_date`, `object_to_date`, `vid_zalog_obespech`, `product_desc`, `sum_zalog_obespech`, `other_info`, `insurance_total_sum`, `insurance_gift`, `payment_currency`, `polis_series`, `polis_from`, `litso`, `passport_copy`, `dogovor_copy`, `spravka_copy`, `spravka_rabota_copy`, `other_copy`, `other`, `file`, `policy_id`, `policy_series_id`, `state`, `created_at`, `updated_at`, `deleted_at`, `period_insurance_from`, `period_insurance_to`, `dogovor_lizing_number`, `dogovor_period_from`, `dogovor_period_to`) VALUES
(1, 102, 49, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 'sdfsdf', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1123', '123213', '12312', 'UZS', NULL, 1, 3234.00, 234234.00, NULL, NULL, NULL, 'img/PolicyHolder/kZrqw3KzJpbbSQlLRJOHueX9k8dXogMU2pH85zPr.png', 'img/PolicyHolder/WxiuNd8EfqrJ0j2yNi9X8KLWrhBG0NBlDPyud8at.png', 'img/PolicyHolder/GNLfEUr3yf1Si15qH1aWLPFHdD3iUTj2sTexro4Q.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-08 17:51:10', '2021-05-08 17:51:10', NULL, '2021-05-16', '2021-05-10', NULL, NULL, NULL),
(2, 103, 50, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 'sdfsdf', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '1123', '123213', '12312', 'UZS', NULL, 1, 3234.00, 234234.00, NULL, NULL, NULL, 'img/PolicyHolder/ZJU0VYaFzvaL24R8RrwqOKsxMpI8tbHvXMl1affH.png', 'img/PolicyHolder/eUzfE5j1rZ763LJJ7245gt4dUfdenbU9cGt7wkCZ.png', 'img/PolicyHolder/6N9SuQR9TSgAyqNCBnzR404iBBm7kL7XXPyVn4IG.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-08 17:52:27', '2021-05-08 17:52:27', NULL, '2021-05-16', '2021-05-10', NULL, NULL, NULL),
(3, 104, 51, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 'sdfsdf', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '21123', '123123', '123123', 'UZS', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-08 20:00:42', '2021-05-08 20:00:42', NULL, '2021-05-23', '2021-05-19', NULL, NULL, NULL),
(4, 105, 52, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 'sdfdsfsdf', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '234234', '3242', '32423', 'UZS', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-08 20:02:18', '2021-05-08 20:02:18', NULL, '2021-05-30', '2021-05-31', NULL, NULL, NULL),
(6, 107, 54, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 'sdfdsfsdf', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '234234', '3242', '32423', 'UZS', NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-08 20:12:23', '2021-05-08 20:12:23', NULL, '2021-05-30', '2021-05-31', NULL, NULL, NULL),
(7, 108, 55, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 'sdfdsfsdf', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '234234', '3242', '32423', 'UZS', NULL, 1, 3234.00, 234234.00, NULL, NULL, NULL, 'img/PolicyHolder/CfmQ6vD8ZXglrZ81PeeBzRvhh7jcuqneM3dLzjzf.png', 'img/PolicyHolder/C4C21PK1Kpx3nBpgDzz8hMwWKfZNaUzwZwtSzR84.png', 'img/PolicyHolder/huzm37Yu4YpWTjrck2HEWcR8FpIPjkyvp1OmzKxt.png', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-08 20:14:00', '2021-05-09 16:42:34', NULL, '2021-05-30', '2021-05-31', NULL, NULL, NULL),
(8, 109, 56, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '998909889322', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '998909889322', '998909889322', '998909889322', 'UZS', NULL, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-09 20:38:01', '2021-05-09 20:38:01', NULL, '2021-05-14', '2021-05-21', NULL, NULL, NULL),
(9, 110, 57, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '998909889322', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '998909889322', '998909889322', '998909889322', 'UZS', NULL, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-05-09 20:55:40', '2021-05-09 20:55:40', NULL, '2021-05-14', '2021-05-21', '998909889322', '2021-05-13', '2021-05-16');
...
(4, 7, '234234', '2021-05-08', '2021-05-09 16:18:02', '2021-05-09 16:18:02', NULL);
...
(1, 141, NULL, 'asdvvd', 'sdfsdfsdf', 1, NULL, NULL, 'in_use', 2, 9, NULL, NULL, '2021-01-09 00:00:00', '2021-03-24 06:13:42', NULL),
(2, 142, NULL, 'asdvvd', '', 1, NULL, NULL, 'in_use', 2, 9, NULL, NULL, '2021-01-09 00:00:00', '2021-03-03 05:13:10', NULL),
(3, 143, '333ggg211', 'asdvvd', '', 1, NULL, NULL, 'in_use', 2, 9, NULL, NULL, '2021-01-09 00:00:00', '2021-03-03 06:13:03', NULL),
...
(49, '23434', 'w4234', '24234', '234234324', '324234', '27576576', NULL, 2, '2021-05-08 17:51:10', '2021-05-08 17:51:10', NULL, 'aa', '123123123', NULL),
(50, '23434', 'w4234', '24234', '234234324', '324234', '27576576', NULL, 2, '2021-05-08 17:52:27', '2021-05-08 17:52:27', NULL, 'aa', '123123123', NULL),
(51, 'sfdsf', 'sdfsdf', '998909889322', '998909889322', '998909889322', '998909889322', NULL, 2, '2021-05-08 20:00:42', '2021-05-08 20:00:42', NULL, 'asdas', '998909889322', NULL),
(52, 'sfdf', 'dsfsdf', '998909889322', '998909889322', '998909889322', '998909889322', NULL, 4, '2021-05-08 20:02:18', '2021-05-08 20:02:18', NULL, 'ff', '998909889322', NULL),
(54, 'sfdf', 'dsfsdf', '998909889322', '998909889322', '998909889322', '998909889322', NULL, 4, '2021-05-08 20:12:23', '2021-05-08 20:12:23', NULL, 'ff', '998909889322', NULL),
(55, 'sfdf', 'dsfsdf', '998909889322', '998909889322', '998909889322', '998909889322', '3242342341', 4, '2021-05-09 16:07:49', '2021-05-08 20:14:00', NULL, 'ff', '998909889322', NULL),
(56, '998909889322', '998909889322', '998909889322', '998909889322', '998909889322', '998909889322', '998909889322', 4, '2021-05-09 20:38:01', '2021-05-09 20:38:01', NULL, '998909889322', '998909889322', NULL),
(57, '998909889322', '998909889322', '998909889322', '998909889322', '998909889322', '998909889322', '998909889322', 4, '2021-05-09 20:55:40', '2021-05-09 20:55:40', NULL, '998909889322', '998909889322', NULL);
...
(102, 'sdfsd', 'sdsdfsdf', '234234', '234234', '234234', 'sdfsdf', NULL, 2, '2021-05-08 17:51:10', '2021-05-08 17:51:10', NULL, NULL, NULL, NULL, NULL),
(103, 'sdfsd', 'sdsdfsdf', '234234', '234234', '234234', 'sdfsdf', NULL, 2, '2021-05-08 17:52:27', '2021-05-08 17:52:27', NULL, NULL, NULL, NULL, NULL),
(104, 'ljljlk', 'n,mnm', '998909889322', '998909889322', '998909889322', '998909889322', NULL, 2, '2021-05-08 20:00:42', '2021-05-08 20:00:42', NULL, NULL, NULL, NULL, NULL),
(105, 'sdfsdf', 'sdsdfsf', '998909889322', '12313', '213123', '234234', NULL, 2, '2021-05-08 20:02:18', '2021-05-08 20:02:18', NULL, NULL, NULL, NULL, NULL),
(107, 'sdfsdf', 'sdsdfsf', '998909889322', '12313', '213123', '234234', NULL, 2, '2021-05-08 20:12:23', '2021-05-08 20:12:23', NULL, NULL, NULL, NULL, NULL),
(108, 'sdfsdf', 'sdsdfsf', '998909889322', '12313', '213123', '234234', NULL, 2, '2021-05-09 16:17:13', '2021-05-08 20:14:00', NULL, '324234', NULL, NULL, NULL),
(109, 'sfsdf', 'fsdf', '998909889322', '998909889322', '998909889322', '998909889322', NULL, 2, '2021-05-09 20:38:01', '2021-05-09 20:38:01', NULL, '998909889322', NULL, NULL, NULL),
(110, 'sfsdf', 'fsdf', '998909889322', '998909889322', '998909889322', '998909889322', NULL, 2, '2021-05-09 20:55:40', '2021-05-09 20:55:40', NULL, '998909889322', NULL, NULL, NULL);
