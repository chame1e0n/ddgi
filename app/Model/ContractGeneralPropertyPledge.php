...
class ContractGeneralPropertyPledge extends Model
{
    ...
    public static $validate = [
        ...
        'contract_general_property_pledge.franchise_earthquake_fire_percent' => 'required',
        'contract_general_property_pledge.franchise_illegal_action_percent' => 'required',
        'contract_general_property_pledge.franchise_other_risks_percent' => 'required',
    ];
